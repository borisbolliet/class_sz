...
if (
  ...
  || ptsz->has_gallens_gallens_1h
  || ptsz->has_gallens_gallens_2h
  || ptsz->has_custom1_gallens_1h
  || ptsz->has_custom1_gallens_2h
  || ptsz->has_gallens_cib_1h
  || ptsz->has_gallens_cib_2h
  || ptsz->has_gallens_lens_1h
  || ptsz->has_gallens_lens_2h
...
if (ptsz->has_electron_density){



if (ptsz->use_fft_for_profiles_transform && ptsz->tau_profile != 0){
...
//  exit(0);
  ...
  tabulate_normalization_gas_density_profile(ptsz,pba);


// double z_asked = exp(ptsz->array_profile_ln_1pz[71])-1.;
// double m_asked = exp(ptsz->array_profile_ln_m[58]);
// double result = get_normalization_gas_density_profile(z_asked,m_asked,ptsz);
...
if (ptsz->has_custom1){
  class_alloc(ptsz->array_custom1_redshift_kernel_W,
              sizeof(double *)*ptsz->array_custom1_redshift_kernel_n_z,
              ptsz->error_message);

  ptsz->n_k_custom1_profile = ptsz->N_samp_fftw;
  int n_x = ptsz->n_k_custom1_profile;
  int n_k = ptsz->n_k_custom1_profile;
  int n_m = ptsz->n_m_custom1_profile;
  int n_z = ptsz->n_z_custom1_profile;

  class_alloc(ptsz->array_custom1_profile_ln_k,sizeof(double *)*n_k,ptsz->error_message);

  double ln_x_min = log(ptsz->x_min_custom1_fftw);
  double ln_x_max = log(ptsz->x_max_custom1_fftw);
  class_alloc(ptsz->array_custom1_profile_ln_x,sizeof(double *)*n_k,ptsz->error_message);
  int index_x;
  for (index_x=0;
       index_x<n_x;
       index_x++)
  {
    ptsz->array_custom1_profile_ln_x[index_x] = ln_x_min
  ...
  class_alloc(ptsz->array_custom1_profile_ln_m,sizeof(double *)*n_m,ptsz->error_message);
  int index_m;
  for (index_m=0;
       index_m<n_m;
       index_m++)
  {
    ptsz->array_custom1_profile_ln_m[index_m] = ln_m_min
  ...
  class_alloc(ptsz->array_custom1_redshift_kernel_ln1pz,sizeof(double *)*ptsz->array_custom1_redshift_kernel_n_z,ptsz->error_message);
  int index_z;
  for (index_z=0;
       index_z<ptsz->array_custom1_redshift_kernel_n_z;
       index_z++)
  {
    ptsz->array_custom1_redshift_kernel_ln1pz[index_z] = ln_1pz_min
                                                  +index_z*(ln_1pz_max-ln_1pz_min)
                                                  /(ptsz->array_custom1_redshift_kernel_n_z-1.);
  }

  class_alloc(ptsz->array_custom1_profile_ln_1pz,sizeof(double *)*n_z,ptsz->error_message);
  // int index_z;
  for (index_z=0;
       index_z<n_z;
       index_z++)
  {
    ptsz->array_custom1_profile_ln_1pz[index_z] = ln_1pz_min
                                                  +index_z*(ln_1pz_max-ln_1pz_min)
                                                  /(n_z-1.);
  }


class_alloc(ptsz->array_custom1_profile_u_at_lnk_lnm_ln1pz,n_k*sizeof(double *),ptsz->error_message);
class_alloc(ptsz->array_custom1_profile_u_at_lnx_lnm_ln1pz,n_k*sizeof(double *),ptsz->error_message);
...
for (index_k=0;
     ...
     index_k++)
    {
    class_alloc(ptsz->array_custom1_profile_u_at_lnk_lnm_ln1pz[index_k],n_m*n_z*sizeof(double *),ptsz->error_message);
    class_alloc(ptsz->array_custom1_profile_u_at_lnx_lnm_ln1pz[index_k],n_m*n_z*sizeof(double *),ptsz->error_message);
        ...
        //class_alloc(ptsz->array_profile_ln_rho_at_lnk_lnM_z[index_l][index_m_z],n_z*sizeof(double ),ptsz->error_message);
            ...
            for (index_z=0;
                 ...
                 index_z++)
              {
                ...
                ptsz->array_custom1_profile_u_at_lnk_lnm_ln1pz[index_k][index_m_z] = log(1e-100); // initialize with super small number
                ptsz->array_custom1_profile_u_at_lnx_lnm_ln1pz[index_k][index_m_z] = log(1e-100); // initialize with super small number
...
if (ptsz->has_custom1){
  tabulate_custom1_profile_fft(pba,ptsz);
}
...
int class_sz_free(struct tszspectrum *ptsz)
{
  if (ptsz->sz_verbose>1) printf("-> freeing memory.\n");
    ...
    int all_comps = ptsz->has_sz_ps
      ...
      + ptsz->has_cib
      + ptsz->has_custom1
      + ptsz->has_electron_density
      + ptsz->has_electron_pressure
      + ptsz->has_lensing
      + ptsz->has_galaxy
      + ptsz->has_matter_density;
  ...
  if (ptsz->sz_verbose>10) printf("-> freeing l and cl's.\n");
   ...
   free(ptsz->cl_custom1_custom1_1h);
   free(ptsz->cl_custom1_custom1_2h);
   free(ptsz->cl_custom1_lens_1h);
   free(ptsz->cl_custom1_lens_2h);
   free(ptsz->cl_custom1_tSZ_1h);
   free(ptsz->cl_custom1_tSZ_2h);
   free(ptsz->cl_custom1_gal_1h);
   free(ptsz->cl_custom1_gal_2h);
   free(ptsz->cl_custom1_gallens_1h);
   free(ptsz->cl_custom1_gallens_2h);
   free(ptsz->cl_gal_gal_1h);
   free(ptsz->cl_gal_gal_2h);
   free(ptsz->cl_gal_gal_hf);
   free(ptsz->cl_tau_gal_1h);
   free(ptsz->cl_tau_gal_2h);
   ...
   free(ptsz->cl_gallens_lensmag_1h);
   free(ptsz->cl_gallens_lensmag_2h);
   ...
   free(ptsz->cl_IA_gal_2h);
   free(ptsz->cl_tSZ_gallens_1h);
   free(ptsz->cl_tSZ_gallens_2h);
  if (ptsz->sz_verbose>10) printf("-> freeing l and cl's cib.\n");
   ...
   for (index_nu=0;index_nu<ptsz->cib_frequency_list_num;index_nu++){
     ...
     free(ptsz->cl_custom1_cib_1h[index_nu]);
     free(ptsz->cl_custom1_cib_2h[index_nu]);
     free(ptsz->cl_lens_cib_1h[index_nu]);
     free(ptsz->cl_lens_cib_2h[index_nu]);
     free(ptsz->cl_gallens_cib_1h[index_nu]);
     free(ptsz->cl_gallens_cib_2h[index_nu]);
 ...
 free(ptsz->galaxy_samples_list);
   ...
   free(ptsz->cl_gallens_cib_1h);
   free(ptsz->cl_gallens_cib_2h);
   free(ptsz->cl_gal_cib_1h);
   free(ptsz->cl_gal_cib_2h);
   free(ptsz->cl_custom1_cib_1h);
   free(ptsz->cl_custom1_cib_2h);
   if (ptsz->has_ngal_ngal_1h
     + ptsz->has_ngal_ngal_2h
     + ptsz->has_ngal_ngal_hf
     + ptsz->has_ngal_lens_1h
   ...
   free(ptsz->cl_gal_gal_lens_1h_fft);
   free(ptsz->cl_gal_gal_lens_2h_fft);
   free(ptsz->cl_gal_gal_lens_3h_fft);
...
if (ptsz->has_electron_density){
  ...
  if (ptsz->tau_profile == 2){
    free(ptsz->array_ln_density_norm_at_z_and_m);
  }
}

if (ptsz->has_custom1){
  free(ptsz->array_custom1_profile_ln_x);
  free(ptsz->array_custom1_profile_ln_k);
  free(ptsz->array_custom1_profile_ln_m);
  free(ptsz->array_custom1_profile_ln_1pz);
   int n_k = ptsz->n_k_custom1_profile; //hard coded
   int index_k;
  for (index_k=0;
       index_k<n_k;
       index_k++)
    {
      free(ptsz->array_custom1_profile_u_at_lnk_lnm_ln1pz[index_k]);
      free(ptsz->array_custom1_profile_u_at_lnx_lnm_ln1pz[index_k]);
    }

  free(ptsz->array_custom1_profile_u_at_lnk_lnm_ln1pz);
  free(ptsz->array_custom1_profile_u_at_lnx_lnm_ln1pz);
...
if ( ptsz->has_gal_gal_lens_1h_fft
  ...
  free(ptsz->array_psi_b1kgg_redshift);
  free(ptsz->array_psi_b1kgg_multipole);
  int iz;
  for (iz=0;iz<ptsz->n_z_psi_b1kgg;iz++)
    free(ptsz->array_psi_b1kgg_psi[iz]);
  free(ptsz->array_psi_b1kgg_psi);
}
...
int compute_sz(struct background * pba,
   ...
   if (index_integrand>=ptsz->index_integrand_id_dndlnM_first && index_integrand <= ptsz->index_integrand_id_dndlnM_last && ptsz->has_dndlnM){
      ...
      if (ptsz->sz_verbose > 0) printf("computing cl^Teyy @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
    ...
    else if (index_integrand>=ptsz->index_integrand_id_gal_gal_lens_1h_fft_first && index_integrand <= ptsz->index_integrand_id_gal_gal_lens_1h_fft_last && ptsz->has_gal_gal_lens_1h_fft){
       Pvectsz[ptsz->index_md] = ptsz->index_md_gal_gal_lens_1h_fft;
       Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal_gal_lens_1h_fft_first);
       Pvectsz[ptsz->index_has_galaxy] = 1;
       Pvectsz[ptsz->index_has_lensing] = 1;
       if (ptsz->sz_verbose > 0) printf("computing cl^gal-gal-lens (1h) FFT @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
     }
     else if (index_integrand>=ptsz->index_integrand_id_gal_gal_lens_2h_fft_first && index_integrand <= ptsz->index_integrand_id_gal_gal_lens_2h_fft_last && ptsz->has_gal_gal_lens_2h_fft){
        Pvectsz[ptsz->index_md] = ptsz->index_md_gal_gal_lens_2h_fft;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal_gal_lens_2h_fft_first);
        Pvectsz[ptsz->index_has_galaxy] = 1;
        Pvectsz[ptsz->index_has_lensing] = 1;
        if (ptsz->sz_verbose > 0) printf("computing cl^gal-gal-lens (2h) FFT @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_gal_gal_lens_3h_fft_first && index_integrand <= ptsz->index_integrand_id_gal_gal_lens_3h_fft_last && ptsz->has_gal_gal_lens_3h_fft){
        Pvectsz[ptsz->index_md] = ptsz->index_md_gal_gal_lens_3h_fft;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal_gal_lens_3h_fft_first);
        Pvectsz[ptsz->index_has_galaxy] = 1;
        Pvectsz[ptsz->index_has_lensing] = 1;
        if (ptsz->sz_verbose > 0) printf("computing cl^gal-gal-lens (3h) FFT @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
       ...
       if (ptsz->sz_verbose > 0) printf("computing cl ksz ksz 2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
     ...
     else if (index_integrand>=ptsz->index_integrand_id_custom1_custom1_1h_first && index_integrand <= ptsz->index_integrand_id_custom1_custom1_1h_last && ptsz->has_custom1_custom1_1h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_custom1_1h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_custom1_1h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-custom1_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_custom1_2h_first && index_integrand <= ptsz->index_integrand_id_custom1_custom1_2h_last && ptsz->has_custom1_custom1_2h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_custom1_2h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_custom1_2h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-custom1_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_lens_1h_first && index_integrand <= ptsz->index_integrand_id_custom1_lens_1h_last && ptsz->has_custom1_lens_1h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_lens_1h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_lensing] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_lens_1h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-lens_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_lens_2h_first && index_integrand <= ptsz->index_integrand_id_custom1_lens_2h_last && ptsz->has_custom1_lens_2h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_lens_2h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_lensing] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_lens_2h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-lens_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_tSZ_1h_first && index_integrand <= ptsz->index_integrand_id_custom1_tSZ_1h_last && ptsz->has_custom1_tSZ_1h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_tSZ_1h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_electron_pressure] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_tSZ_1h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-tSZ_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_tSZ_2h_first && index_integrand <= ptsz->index_integrand_id_custom1_tSZ_2h_last && ptsz->has_custom1_tSZ_2h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_tSZ_2h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_electron_pressure] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_tSZ_2h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-tSZ_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_gallens_1h_first && index_integrand <= ptsz->index_integrand_id_custom1_gallens_1h_last && ptsz->has_custom1_gallens_1h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_gallens_1h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_lensing] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_gallens_1h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-gallens_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_gallens_2h_first && index_integrand <= ptsz->index_integrand_id_custom1_gallens_2h_last && ptsz->has_custom1_gallens_2h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_gallens_2h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_lensing] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_gallens_2h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-gallens_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_gal_1h_first && index_integrand <= ptsz->index_integrand_id_custom1_gal_1h_last && ptsz->has_custom1_gal_1h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_gal_1h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_galaxy] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_gal_1h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-gal_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }
     else if (index_integrand>=ptsz->index_integrand_id_custom1_gal_2h_first && index_integrand <= ptsz->index_integrand_id_custom1_gal_2h_last && ptsz->has_custom1_gal_2h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_gal_2h;
        Pvectsz[ptsz->index_has_custom1] = 1;
        Pvectsz[ptsz->index_has_galaxy] = 1;
        Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_custom1_gal_2h_first);
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-gal_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
      }

      else if (index_integrand>=ptsz->index_integrand_id_custom1_cib_1h_first && index_integrand <= ptsz->index_integrand_id_custom1_cib_1h_last && ptsz->has_custom1_cib_1h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_cib_1h;
        int index_multipole_cib1 = (double) (index_integrand - ptsz->index_integrand_id_custom1_cib_1h_first);
        ...
        Pvectsz[ptsz->index_has_cib] = 1;
        Pvectsz[ptsz->index_has_custom1] = 1;
        if (ptsz->sz_verbose > 0) printf("computing cl^custom1-cib_1h @ frequency_id = %.0f, ell_id = %.0f\n",
                                         Pvectsz[ptsz->index_frequency_for_cib_profile],
                                         Pvectsz[ptsz->index_multipole]);
        }
       else if (index_integrand>=ptsz->index_integrand_id_custom1_cib_2h_first && index_integrand <= ptsz->index_integrand_id_custom1_cib_2h_last && ptsz->has_custom1_cib_2h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_custom1_cib_2h;
          int index_multipole_cib1 = (double) (index_integrand - ptsz->index_integrand_id_custom1_cib_2h_first);
          int index_cib1 = index_multipole_cib1 / ptsz->nlSZ;
          int index_multipole = index_multipole_cib1 % ptsz->nlSZ;
          Pvectsz[ptsz->index_multipole] = (double) index_multipole ;
          Pvectsz[ptsz->index_frequency_for_cib_profile] = (double) index_cib1;
          Pvectsz[ptsz->index_has_cib] = 1;
          Pvectsz[ptsz->index_has_custom1] = 1;
          if (ptsz->sz_verbose > 0) printf("computing cl^custom1-cib_2h @ frequency_id = %.0f, ell_id = %.0f\n",
                                           Pvectsz[ptsz->index_frequency_for_cib_profile],
                                           Pvectsz[ptsz->index_multipole]);
        }
      ...
      else if (index_integrand>=ptsz->index_integrand_id_tau_gal_1h_first && index_integrand <= ptsz->index_integrand_id_tau_gal_1h_last && ptsz->has_tau_gal_1h){
         Pvectsz[ptsz->index_md] = ptsz->index_md_tau_gal_1h;
         Pvectsz[ptsz->index_has_galaxy] = 1;
         Pvectsz[ptsz->index_has_electron_density] = 1;
         Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_tau_gal_1h_first);
         if (ptsz->sz_verbose > 0) printf("computing cl^tau_gal_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
       }
       else if (index_integrand>=ptsz->index_integrand_id_tau_gal_2h_first && index_integrand <= ptsz->index_integrand_id_tau_gal_2h_last && ptsz->has_tau_gal_2h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_tau_gal_2h;
          Pvectsz[ptsz->index_has_galaxy] = 1;
          Pvectsz[ptsz->index_has_electron_density] = 1;
          Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_tau_gal_2h_first);
          if (ptsz->sz_verbose > 0) printf("computing cl^tau_gal_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
        }
      ...
      else if (index_integrand>=ptsz->index_integrand_id_tSZ_gallens_1h_first && index_integrand <= ptsz->index_integrand_id_tSZ_gallens_1h_last && ptsz->has_tSZ_gallens_1h){
         Pvectsz[ptsz->index_md] = ptsz->index_md_tSZ_gallens_1h;
         // Pvectsz[ptsz->index_has_galaxy] = 1;
         Pvectsz[ptsz->index_has_lensing] = 1;
         Pvectsz[ptsz->index_has_electron_pressure] = 1;
         Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_tSZ_gallens_1h_first);
         if (ptsz->sz_verbose > 0) printf("computing cl^tSZ-gallens_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
       }
       else if (index_integrand>=ptsz->index_integrand_id_tSZ_gallens_2h_first && index_integrand <= ptsz->index_integrand_id_tSZ_gallens_2h_last && ptsz->has_tSZ_gallens_2h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_tSZ_gallens_2h;
          // Pvectsz[ptsz->index_has_galaxy] = 1;
          Pvectsz[ptsz->index_has_lensing] = 1;
          Pvectsz[ptsz->index_has_electron_pressure] = 1;
          Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_tSZ_gallens_2h_first);
          if (ptsz->sz_verbose > 0) printf("computing cl^tSZ-gallens_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
        }
        ...
        else if (index_integrand>=ptsz->index_integrand_id_gallens_lensmag_1h_first && index_integrand <= ptsz->index_integrand_id_gallens_lensmag_1h_last && ptsz->has_gallens_lensmag_1h){
           Pvectsz[ptsz->index_md] = ptsz->index_md_gallens_lensmag_1h;
           Pvectsz[ptsz->index_has_lensing] = 1;
           Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gallens_lensmag_1h_first);
           if (ptsz->sz_verbose > 0) printf("computing cl^gallens-lensmag_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
         }
       else if (index_integrand>=ptsz->index_integrand_id_gallens_lensmag_2h_first && index_integrand <= ptsz->index_integrand_id_gallens_lensmag_2h_last && ptsz->has_gallens_lensmag_2h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_gallens_lensmag_2h;
          Pvectsz[ptsz->index_has_lensing] = 1;
          Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gallens_lensmag_2h_first);
          if (ptsz->sz_verbose > 0) printf("computing cl^gallens-lensmag_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
        }
      ...
      else if (index_integrand>=ptsz->index_integrand_id_gallens_cib_1h_first && index_integrand <= ptsz->index_integrand_id_gallens_cib_1h_last && ptsz->has_gallens_cib_1h){
        Pvectsz[ptsz->index_md] = ptsz->index_md_gallens_cib_1h;
        int index_multipole_cib1 = (double) (index_integrand - ptsz->index_integrand_id_gallens_cib_1h_first);
        int index_cib1 = index_multipole_cib1 / ptsz->nlSZ;
        int index_multipole = index_multipole_cib1 % ptsz->nlSZ;
        Pvectsz[ptsz->index_multipole] = (double) index_multipole ;
        Pvectsz[ptsz->index_frequency_for_cib_profile] = (double) index_cib1;
        Pvectsz[ptsz->index_has_cib] = 1;
        Pvectsz[ptsz->index_has_lensing] = 1;
        if (ptsz->sz_verbose > 0) printf("computing cl^gallens-cib_1h @ frequency_id = %.0f, ell_id = %.0f\n",
                                         Pvectsz[ptsz->index_frequency_for_cib_profile],
                                         Pvectsz[ptsz->index_multipole]);
        }
       else if (index_integrand>=ptsz->index_integrand_id_gallens_cib_2h_first && index_integrand <= ptsz->index_integrand_id_gallens_cib_2h_last && ptsz->has_gallens_cib_2h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_gallens_cib_2h;
          int index_multipole_cib1 = (double) (index_integrand - ptsz->index_integrand_id_gallens_cib_2h_first);
          int index_cib1 = index_multipole_cib1 / ptsz->nlSZ;
          int index_multipole = index_multipole_cib1 % ptsz->nlSZ;
          Pvectsz[ptsz->index_multipole] = (double) index_multipole ;
          Pvectsz[ptsz->index_frequency_for_cib_profile] = (double) index_cib1;
          Pvectsz[ptsz->index_has_cib] = 1;
          Pvectsz[ptsz->index_has_lensing] = 1;
          if (ptsz->sz_verbose > 0) printf("computing cl^gallens-cib_2h @ frequency_id = %.0f, ell_id = %.0f\n",
                                           Pvectsz[ptsz->index_frequency_for_cib_profile],
                                           Pvectsz[ptsz->index_multipole]);
        }
      ...
      else if (index_integrand>=ptsz->index_integrand_id_IA_gal_2h_first && index_integrand <= ptsz->index_integrand_id_IA_gal_2h_last && ptsz->has_IA_gal_2h){
         Pvectsz[ptsz->index_md] = ptsz->index_md_IA_gal_2h;
         // Pvectsz[ptsz->index_has_electron_pressure] = 1;
         Pvectsz[ptsz->index_has_galaxy] = 1;
         Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_IA_gal_2h_first);
         if (ptsz->sz_verbose > 0) printf("computing cl^IA-gal_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
       }
...
// printf("r 0-pi = %.8e \n",r);
 ...
 // We collect the results hereafter...
   ...
   // if (1==0){
     int index_l = (int) Pvectsz[ptsz->index_multipole];
     ptsz->cl_gal_gal_lens_1h_fft[index_l] = Pvectsz[ptsz->index_integral]/(2.*_PI_)/(2.*_PI_);
   }
   if (_gal_gal_lens_2h_fft_){
   // if (1==0){
     int index_l = (int) Pvectsz[ptsz->index_multipole];
     ptsz->cl_gal_gal_lens_2h_fft[index_l] = Pvectsz[ptsz->index_integral]/(2.*_PI_)/(2.*_PI_);
   }
   if (_gal_gal_lens_3h_fft_){
   // if (1==0){
     int index_l = (int) Pvectsz[ptsz->index_multipole];
     ptsz->cl_gal_gal_lens_3h_fft[index_l] = Pvectsz[ptsz->index_integral]/(2.*_PI_)/(2.*_PI_);
   }
...
if (_tau_gal_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_tau_gal_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_tau_gal_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_tau_gal_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_tSZ_gallens_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_tSZ_gallens_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_)/pow(ptsz->Tcmb_gNU,1);
  // printf("%.3e\n",ptsz->cl_gal_gallens_1h[index_l]);
  if (isnan(ptsz->cl_tSZ_gallens_1h[index_l])||isinf(ptsz->cl_tSZ_gallens_1h[index_l])){
  printf("nan or inf in cls 1h\n");
  exit(0);
  }
}
...
if (_tSZ_gallens_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_tSZ_gallens_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_)/pow(ptsz->Tcmb_gNU,1);
...
if (_gallens_lensmag_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gallens_lensmag_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_gallens_lensmag_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gallens_lensmag_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_IA_gal_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_IA_gal_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
 //printf("ell = %.3e and cl_yg = %.3e\n",ptsz->ell[index_l],ptsz->cl_tSZ_gal_1h[index_l]);
...
if (_custom1_custom1_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_custom1_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_custom1_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_custom1_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_lens_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_lens_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_lens_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_lens_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_tSZ_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_tSZ_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_)/pow(ptsz->Tcmb_gNU,1);
...
if (_custom1_tSZ_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_tSZ_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_)/pow(ptsz->Tcmb_gNU,1);
...
if (_custom1_gal_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_gal_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_gal_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_gal_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_gallens_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_gallens_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_gallens_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_custom1_gallens_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_custom1_cib_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 int index_cib1 = (int) Pvectsz[ptsz->index_frequency_for_cib_profile];
 ptsz->cl_custom1_cib_1h[index_cib1][index_l] = Pvectsz[ptsz->index_integral]
                                             *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                             /(2*_PI_);
 //printf("ell = %.3e and cl_yg = %.3e\n",ptsz->ell[index_l],ptsz->cl_tSZ_gal_1h[index_l]);
...
int index_l = (int) Pvectsz[ptsz->index_multipole];
int index_cib1 = (int) Pvectsz[ptsz->index_frequency_for_cib_profile];
ptsz->cl_custom1_cib_2h[index_cib1][index_l] = Pvectsz[ptsz->index_integral]
                                            *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                            /(2*_PI_);
//printf("ell = %.3e and cl_yg = %.3e\n",ptsz->ell[index_l],ptsz->cl_tSZ_gal_1h[index_l]);
...
if (_gallens_cib_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 int index_cib1 = (int) Pvectsz[ptsz->index_frequency_for_cib_profile];
 ptsz->cl_gallens_cib_1h[index_cib1][index_l] = Pvectsz[ptsz->index_integral]
                                             *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                             /(2*_PI_);
 //printf("ell = %.3e and cl_yg = %.3e\n",ptsz->ell[index_l],ptsz->cl_tSZ_gal_1h[index_l]);
...
int index_l = (int) Pvectsz[ptsz->index_multipole];
int index_cib1 = (int) Pvectsz[ptsz->index_frequency_for_cib_profile];
ptsz->cl_gallens_cib_2h[index_cib1][index_l] = Pvectsz[ptsz->index_integral]
                                           *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                           /(2*_PI_);
//printf("ell = %.3e and cl_yg = %.3e\n",ptsz->ell[index_l],ptsz->cl_tSZ_gal_1h[index_l]);
...
double integrand_at_m_and_z(double logM,
  ...
  // printf("mhmf = %.3e m500c = %.3e m = %.3e z=%.3e\n",pvectsz[ptsz->index_mass_for_hmf],pvectsz[ptsz->index_m500c],exp(logM),z);
   ...
   m_delta_custom1 = pvectsz[ptsz->index_mass_for_custom1];
   r_delta_custom1 = pvectsz[ptsz->index_radius_for_custom1];
   c_delta_custom1 = pvectsz[ptsz->index_concentration_for_custom1];
...
if ((int) pvectsz[ptsz->index_part_id_cov_hsv] ==  6) {
  ...
  if ((int) pvectsz[ptsz->index_part_id_cov_hsv] ==  12) {
    ...
    double l_max = ptsz->l_max_samp_fftw; // this is a precision parameter
        ...
        double kp = (l+0.5)/chi;
        evaluate_galaxy_profile_2h(kp,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);
        taul = pvectsz[ptsz->index_galaxy_profile];
        Pk[ik] = fl*taul;
        Pko[ik] = fl*taul;
        }
...
taul = pvectsz[ptsz->index_galaxy_profile];//get_tau_profile_at_z_m_l(z,m,l,ptsz,pba);
Pk[ik] = fl*taul;
Pko[ik] = fl*taul;
// if(l>3e3)
//   printf("k = %.5e pk = %.5e\n",l,Pk[ik]);
...
////end configurations.
   ...
   double lensing_profile_at_ell_2 = pvectsz[ptsz->index_lensing_profile];
    ...
    if (ptsz->tau_profile == 2){ //BCM Needs to be normalized here:
        gas_profile_at_k_1 = get_gas_density_profile_at_k_M_z(k_asked,m_delta_electron_density,z,1,ptsz);
      }
    else{
...
if ((int) pvectsz[ptsz->index_part_id_cov_hsv] ==  6) {
    ...
    // pvecback[pba->index_bg_ang_distance] = 789.9;
             ...
             // int index_l = (int) pvectsz[ptsz->index_multipole];
             // pvectsz[ptsz->index_multipole_for_lensing_profile] = ptsz->ell[index_l];
             evaluate_tau_profile(kl,pvecback,pvectsz,pba,ptsz);             // pvectsz[ptsz->index_multipole_for_galaxy_profile] =  ptsz->ell[index_l];
             evaluate_galaxy_profile_2h(kl,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);
...
// printf("tsz lensmag 2h %.3f\n",1.);
            ...
            printf("%.5e %.5e %.5e\n",pvectsz[ptsz->index_hmf],pressure_profile_at_ell ,lensing_profile_at_ell_2);
            exit(0);
            }
...
// printf("tsz lensmag 2h %.3f\n",1.);
    ...
    double custom1_at_ell_1 = get_custom1_profile_at_k_m_z(ql_custom1,m_delta_custom1,z,ptsz);
        ...
        pvectsz[ptsz->index_integrand] =  pvectsz[ptsz->index_hmf]
            ...
            if (isnan(pvectsz[ptsz->index_integrand])||isinf(pvectsz[ptsz->index_integrand])){
            printf("nan or inf in integrand tsz-gallens 1h\n");
            printf("%.5e %.5e %.5e\n",pvectsz[ptsz->index_hmf],custom1_at_ell_1 ,lensing_profile_at_ell_2);
            exit(0);
            }
                        ...
                        struct tszspectrum * ptsz)
{
  ...
  double m_asked;
   ...
   // printf("l_asked %.8e")
    ...
    //   }
    double gas_profile_at_k_1;
    double k_asked = k*(1.+z_asked)*pvectsz[ptsz->index_radius_for_electron_density];
    if (ptsz->tau_profile == 2){ //BCM Needs to be normalized here:
        gas_profile_at_k_1 = get_gas_density_profile_at_k_M_z(k_asked,m_asked,z_asked,1,ptsz);
      }
    else{
      gas_profile_at_k_1 = get_gas_density_profile_at_k_M_z(k_asked,m_asked,z_asked,0,ptsz);
      }
                              ...
                              struct tszspectrum * ptsz)
{
  ...
  //m500 X-ray for the pressure profiles A10 and P13
   ...
   //(see comments after to link this way of writing with the szfast implementation)
   pvectsz[ptsz->index_pressure_profile] = ptsz->sigmaT_over_mec2_times_50eV_per_cm3_times_Tcmb // here Tcmb is in muK
                                           /50. // to cancel the factor 50 above 50eV/cm^3
                                           /pba->T_cmb
                                           *pressure_normalisation
                                           *pvectsz[ptsz->index_pressure_profile]
...
// custom1
if (pvectsz[ptsz->index_has_custom1] == 1){
   // galaxies
  if (ptsz->delta_def_custom1 == 0){
    m_delta_custom1 = pvectsz[ptsz->index_m200m];
    r_delta_custom1 = pvectsz[ptsz->index_r200m];
    c_delta_custom1 = pvectsz[ptsz->index_c200m];
  }
  else if (ptsz->delta_def_custom1 == 1){
    m_delta_custom1 = pvectsz[ptsz->index_m200c];
    r_delta_custom1 = pvectsz[ptsz->index_r200c];
    c_delta_custom1 = pvectsz[ptsz->index_c200c];
    // printf("setting galaxy's delta\n");
    // printf("c_delta_gal = %.5e\n",c_delta_gal);
  }
  else if (ptsz->delta_def_custom1 == 2){
    m_delta_custom1 = pvectsz[ptsz->index_m500c];
    r_delta_custom1 = pvectsz[ptsz->index_r500c];
    c_delta_custom1 = pvectsz[ptsz->index_c500c];
  }

  else if (ptsz->delta_def_custom1 == 3){
    m_delta_custom1 = pvectsz[ptsz->index_mVIR];
    r_delta_custom1 = pvectsz[ptsz->index_rVIR];
    c_delta_custom1 = pvectsz[ptsz->index_cVIR];
  }

  pvectsz[ptsz->index_mass_for_custom1] = m_delta_custom1;
  pvectsz[ptsz->index_radius_for_custom1] = r_delta_custom1;
  pvectsz[ptsz->index_concentration_for_custom1] = c_delta_custom1;
 }// end galaxies
      ...
      for (index_l=0;index_l<ptsz->nlSZ;index_l++){
         ...
         double cov_cl_cl_2h = sig_cl_squared_binned_2h + ptsz->tllprime_sz[index_l][index_l]/ptsz->Omega_survey;
            ...
            fprintf(fp,
                    ...
                    ptsz->cl_lens_lensmag_2h[index_l],
                    ptsz->cl_gallens_lensmag_1h[index_l],
                    ptsz->cl_gallens_lensmag_2h[index_l],
...
printf("ell = %e\t\t cl_gal_gal_lens_1h_fft = %e \n",ptsz->ell[index_l],ptsz->cl_gal_gal_lens_1h_fft[index_l]);
}
}

if (ptsz->has_gal_gal_lens_2h_fft){
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal_gal_lens_2h_fft = %e \n",ptsz->ell[index_l],ptsz->cl_gal_gal_lens_2h_fft[index_l]);
}
}

if (ptsz->has_gal_gal_lens_3h_fft){
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal_gal_lens_3h_fft = %e \n",ptsz->ell[index_l],ptsz->cl_gal_gal_lens_3h_fft[index_l]);
}
}
...
if (ptsz->has_gallens_lensmag_1h){
printf("\n\n");
printf("#######################################################\n");
...
printf("ell = %e\t\t cl_gallens_lensmag (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_gallens_lensmag_1h[index_l]);
}
}
if (ptsz->has_gallens_lensmag_2h){
printf("\n\n");
printf("#######################################################\n");
...
printf("ell = %e\t\t cl_gallens_lensmag (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_gallens_lensmag_2h[index_l]);
}
}

if (ptsz->has_tau_gal_1h){
printf("\n\n");
printf("##########################################################\n");
...
printf("ell = %e\t\t cl_tau_gal (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_tau_gal_1h[index_l]);
}
}
if (ptsz->has_tau_gal_2h){
printf("\n\n");
printf("##########################################################\n");
...
printf("ell = %e\t\t cl_tau_gal (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_tau_gal_2h[index_l]);
}
}
...
printf("ell = %e\t\t cl_tSZ_gallens (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_tSZ_gallens_1h[index_l]);
}
}
if (ptsz->has_tSZ_gallens_2h){
printf("\n\n");
printf("##########################################################\n");
...
printf("ell = %e\t\t cl_tSZ_gallens (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_tSZ_gallens_2h[index_l]);
}
}
if (ptsz->has_gal_gallens_1h){
printf("\n\n");
...
printf("ell = %e\t\t cl_gallens_cib (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_gallens_cib_2h[index_nu][index_l]);
}
// }
}
}
...
// here make sure we bypass all the hm consistency in case its not asked.
   ...
   if (ptsz->has_sz_ps
      ...
      +ptsz->has_tSZ_cib_2h
      +ptsz->has_sz_trispec
      +ptsz->has_electron_pressure != _FALSE_){
   ...
   if (ptsz->has_kSZ_kSZ_gal_1h
      ...
      +ptsz->has_kSZ_kSZ_tSZ_3h
      +ptsz->has_kSZ_kSZ_lensmag_1halo
      +ptsz->has_electron_density != _FALSE_){
...
if (ptsz->need_hmf){
  ...
  if (ptsz->integrate_wrt_m500c == 1 && ptsz->has_200c == 1)
   ...
   ptsz->index_has_custom1 = ptsz->index_has_isw + 1;

   ptsz->index_has_vir =  ptsz->index_has_custom1 + 1;
  ...
  ptsz->index_mass_for_custom1 = ptsz->index_concentration_for_HI_density +1;
  ptsz->index_radius_for_custom1 = ptsz->index_mass_for_custom1 +1;
  ptsz->index_concentration_for_custom1 = ptsz->index_radius_for_custom1+1;

   //final size of pvecsz vector
  ptsz->tsz_size  = ptsz->index_concentration_for_custom1 + 1;
...
//exit(0);
   ...
   class_alloc(ptsz->cl_IA_gal_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   class_alloc(ptsz->cl_tau_gal_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_tau_gal_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gal_gal_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_custom1_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_custom1_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_lens_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_lens_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_tSZ_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_tSZ_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_gal_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_gal_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_gallens_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_gallens_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   class_alloc(ptsz->cl_tSZ_gallens_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_tSZ_gallens_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   class_alloc(ptsz->cl_gallens_lensmag_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gallens_lensmag_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   class_alloc(ptsz->cl_gal_gal_lens_1h_fft,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gal_gal_lens_2h_fft,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gal_gal_lens_3h_fft,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   for (index_l=0;index_l<ptsz->nlSZ;index_l++){
      ...
      ptsz->cl_custom1_custom1_1h[index_l] = 0.;
      ptsz->cl_custom1_custom1_2h[index_l] = 0.;
      ptsz->cl_custom1_lens_1h[index_l] = 0.;
      ptsz->cl_custom1_lens_2h[index_l] = 0.;
      ptsz->cl_custom1_tSZ_1h[index_l] = 0.;
      ptsz->cl_custom1_tSZ_2h[index_l] = 0.;
      ptsz->cl_custom1_gallens_1h[index_l] = 0.;
      ptsz->cl_custom1_gallens_2h[index_l] = 0.;
      ptsz->cl_custom1_gal_1h[index_l] = 0.;
      ptsz->cl_custom1_gal_2h[index_l] = 0.;
      ...
      ptsz->cl_tau_gal_1h[index_l] = 0.;
      ptsz->cl_tau_gal_2h[index_l] = 0.;
      ...
      ptsz->cl_tSZ_gallens_1h[index_l] = 0.;
      ptsz->cl_tSZ_gallens_2h[index_l] = 0.;
      ...
      ptsz->cl_gallens_lensmag_1h[index_l] = 0.;
      ptsz->cl_gallens_lensmag_2h[index_l] = 0.;
      ...
      ptsz->cl_gal_gal_lens_1h_fft[index_l] = 0.;
      ptsz->cl_gal_gal_lens_2h_fft[index_l] = 0.;
      ptsz->cl_gal_gal_lens_3h_fft[index_l] = 0.;
   ...
   class_alloc(ptsz->cl_custom1_cib_1h,sizeof(double **)*ptsz->cib_frequency_list_num,ptsz->error_message);
   class_alloc(ptsz->cl_custom1_cib_2h,sizeof(double **)*ptsz->cib_frequency_list_num,ptsz->error_message);
   ...
   class_alloc(ptsz->cl_gallens_cib_1h,sizeof(double **)*ptsz->cib_frequency_list_num,ptsz->error_message);
   class_alloc(ptsz->cl_gallens_cib_2h,sizeof(double **)*ptsz->cib_frequency_list_num,ptsz->error_message);
   ...
   for (index_nu=0;index_nu<ptsz->cib_frequency_list_num;index_nu++){
     class_alloc(ptsz->cl_custom1_cib_1h[index_nu],sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
     class_alloc(ptsz->cl_custom1_cib_2h[index_nu],sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
     ...
     class_alloc(ptsz->cl_gallens_cib_1h[index_nu],sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
     class_alloc(ptsz->cl_gallens_cib_2h[index_nu],sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
for (index_l=0;index_l<ptsz->nlSZ;index_l++){
  ptsz->cl_custom1_cib_1h[index_nu][index_l] = 0.;
  ptsz->cl_custom1_cib_2h[index_nu][index_l] = 0.;
  ...
  ptsz->cl_gallens_cib_1h[index_nu][index_l] = 0.;
  ptsz->cl_gallens_cib_2h[index_nu][index_l] = 0.;
}
   }
 ...
 // printf("counting integrands\n");
   ...
   ptsz->index_integrand_id_gal_gal_lens_1h_fft_first = ptsz->index_integrand_id_kSZ_kSZ_lens_3h_fft_last + 1;
   ptsz->index_integrand_id_gal_gal_lens_1h_fft_last = ptsz->index_integrand_id_gal_gal_lens_1h_fft_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_gal_gal_lens_2h_fft_first = ptsz->index_integrand_id_gal_gal_lens_1h_fft_last + 1;
   ptsz->index_integrand_id_gal_gal_lens_2h_fft_last = ptsz->index_integrand_id_gal_gal_lens_2h_fft_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_gal_gal_lens_3h_fft_first = ptsz->index_integrand_id_gal_gal_lens_2h_fft_last + 1;
   ptsz->index_integrand_id_gal_gal_lens_3h_fft_last = ptsz->index_integrand_id_gal_gal_lens_3h_fft_first + ptsz->nlSZ - 1;


   ptsz->index_integrand_id_kSZ_kSZ_gal_2h_first = ptsz->index_integrand_id_gal_gal_lens_3h_fft_last + 1;
   ...
   ptsz->index_integrand_id_IA_gal_2h_first = ptsz->index_integrand_id_tSZ_gal_2h_last + 1;
   ptsz->index_integrand_id_IA_gal_2h_last = ptsz->index_integrand_id_IA_gal_2h_first + ptsz->nlSZ - 1;

   last_index_integrand_id = ptsz->index_integrand_id_IA_gal_2h_last;
 ...
 last_index_integrand_id =  ptsz->index_integrand_id_pk_b_at_z_2h_last;
   ...
   ptsz->index_integrand_id_tSZ_gallens_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_tSZ_gallens_1h_last = ptsz->index_integrand_id_tSZ_gallens_1h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_tSZ_gallens_1h_last;

   ptsz->index_integrand_id_tSZ_gallens_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_tSZ_gallens_2h_last = ptsz->index_integrand_id_tSZ_gallens_2h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_tSZ_gallens_2h_last;


   ptsz->index_integrand_id_gallens_cib_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_gallens_cib_1h_last = ptsz->index_integrand_id_gallens_cib_1h_first + ptsz->nlSZ*ptsz->cib_frequency_list_num - 1;
   last_index_integrand_id = ptsz->index_integrand_id_gallens_cib_1h_last;

   ptsz->index_integrand_id_gallens_cib_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_gallens_cib_2h_last = ptsz->index_integrand_id_gallens_cib_2h_first + ptsz->nlSZ*ptsz->cib_frequency_list_num - 1;
   last_index_integrand_id = ptsz->index_integrand_id_gallens_cib_2h_last;


   ptsz->index_integrand_id_tau_gal_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_tau_gal_1h_last = ptsz->index_integrand_id_tau_gal_1h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_tau_gal_1h_last;

   ptsz->index_integrand_id_tau_gal_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_tau_gal_2h_last = ptsz->index_integrand_id_tau_gal_2h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_tau_gal_2h_last;
   ...
   ptsz->index_integrand_id_custom1_custom1_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_custom1_1h_last = ptsz->index_integrand_id_custom1_custom1_1h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_custom1_1h_last;

   ptsz->index_integrand_id_custom1_custom1_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_custom1_2h_last = ptsz->index_integrand_id_custom1_custom1_2h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_custom1_2h_last;

   ptsz->index_integrand_id_custom1_lens_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_lens_1h_last = ptsz->index_integrand_id_custom1_lens_1h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_lens_1h_last;

   ptsz->index_integrand_id_custom1_lens_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_lens_2h_last = ptsz->index_integrand_id_custom1_lens_2h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_lens_2h_last;

   ptsz->index_integrand_id_custom1_tSZ_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_tSZ_1h_last = ptsz->index_integrand_id_custom1_tSZ_1h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_tSZ_1h_last;

   ptsz->index_integrand_id_custom1_tSZ_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_tSZ_2h_last = ptsz->index_integrand_id_custom1_tSZ_2h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_tSZ_2h_last;

   ptsz->index_integrand_id_custom1_gal_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_gal_1h_last = ptsz->index_integrand_id_custom1_gal_1h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_gal_1h_last;

   ptsz->index_integrand_id_custom1_gal_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_gal_2h_last = ptsz->index_integrand_id_custom1_gal_2h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_gal_2h_last;

   ptsz->index_integrand_id_custom1_gallens_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_gallens_1h_last = ptsz->index_integrand_id_custom1_gallens_1h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_gallens_1h_last;

   ptsz->index_integrand_id_custom1_gallens_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_gallens_2h_last = ptsz->index_integrand_id_custom1_gallens_2h_first + ptsz->nlSZ - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_gallens_2h_last;

   ptsz->index_integrand_id_custom1_cib_1h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_cib_1h_last = ptsz->index_integrand_id_custom1_cib_1h_first + ptsz->nlSZ*ptsz->cib_frequency_list_num - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_cib_1h_last;

   ptsz->index_integrand_id_custom1_cib_2h_first = last_index_integrand_id + 1;
   ptsz->index_integrand_id_custom1_cib_2h_last = ptsz->index_integrand_id_custom1_cib_2h_first + ptsz->nlSZ*ptsz->cib_frequency_list_num - 1;
   last_index_integrand_id = ptsz->index_integrand_id_custom1_cib_2h_last;
   ...
   ptsz->index_integrand_id_gallens_gallens_1h_first = ptsz->index_integrand_id_gal_lensmag_1h_last + 1;
   ...
   ptsz->index_integrand_id_gallens_lensmag_1h_first = ptsz->index_integrand_id_lens_lensmag_1h_last + 1;
   ptsz->index_integrand_id_gallens_lensmag_1h_last = ptsz->index_integrand_id_gallens_lensmag_1h_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_cib_cib_2h_first = ptsz->index_integrand_id_gallens_lensmag_1h_last + 1;
   ...
   ptsz->index_integrand_id_gallens_lensmag_2h_first = ptsz->index_integrand_id_lens_lensmag_2h_last + 1;
   ptsz->index_integrand_id_gallens_lensmag_2h_last = ptsz->index_integrand_id_gallens_lensmag_2h_first + ptsz->nlSZ - 1;

   ptsz->index_integrand_id_lens_lens_1h_first = ptsz->index_integrand_id_gallens_lensmag_2h_last + 1;
