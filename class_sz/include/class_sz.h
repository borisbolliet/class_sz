...
#define _gal1_lensmag2_2h_ ((ptsz->has_gal1_lensmag2_2h == _TRUE_) && (index_md == ptsz->index_md_gal1_lensmag2_2h))
#define _gal1_lensmag2_1h_ ((ptsz->has_gal1_lensmag2_1h == _TRUE_) && (index_md == ptsz->index_md_gal1_lensmag2_1h))
#define _gal2_lensmag1_2h_ ((ptsz->has_gal2_lensmag1_2h == _TRUE_) && (index_md == ptsz->index_md_gal2_lensmag1_2h))
#define _gal2_lensmag1_1h_ ((ptsz->has_gal2_lensmag1_1h == _TRUE_) && (index_md == ptsz->index_md_gal2_lensmag1_1h))
...
#define _cib_lensmag_1h_ ((ptsz->has_cib_lensmag_1h == _TRUE_) && (index_md == ptsz->index_md_cib_lensmag_1h))
#define _cib_lensmag_2h_ ((ptsz->has_cib_lensmag_2h == _TRUE_) && (index_md == ptsz->index_md_cib_lensmag_2h))
...
#define _gal1_gal2_1h_ ((ptsz->has_gal1_gal2_1h == _TRUE_) && (index_md == ptsz->index_md_gal1_gal2_1h))
#define _gal1_gal2_2h_ ((ptsz->has_gal1_gal2_2h == _TRUE_) && (index_md == ptsz->index_md_gal1_gal2_2h))
#define _lensmag1_lensmag2_2h_ ((ptsz->has_lensmag1_lensmag2_2h == _TRUE_) && (index_md == ptsz->index_md_lensmag1_lensmag2_2h)) // OK debug
#define _lensmag1_lensmag2_1h_ ((ptsz->has_lensmag1_lensmag2_1h == _TRUE_) && (index_md == ptsz->index_md_lensmag1_lensmag2_1h))
...
struct tszspectrum {
  ...
  int galaxy_sample;
  int unwise_galaxy_sample_id1;
  int galaxy_sample1;
  int unwise_galaxy_sample_id2;
  int galaxy_sample2;
  ...
  double * cl_gal1_gal2_1h;
  double * cl_gal1_gal2_2h;
  ...
  double * cl_gal1_lensmag2_1h; // OK
  double * cl_gal1_lensmag2_2h;
  double * cl_gal2_lensmag1_1h;
  double * cl_gal2_lensmag1_2h;
  ...
  double * cl_lensmag1_lensmag2_2h;
  double * cl_lensmag1_lensmag2_1h;
  ...
  double ** cl_cib_lensmag_1h;
  double ** cl_cib_lensmag_2h;
  ...
  int has_mean_galaxy1_bias;
  int has_mean_galaxy2_bias;
  int has_ng_in_bh;
  double fNL;
...
// gal 1 x gal 2
  int has_gal1_gal2_1h;
  int index_md_gal1_gal2_1h;
  int index_integrand_id_gal1_gal2_1h_first;
  int index_integrand_id_gal1_gal2_1h_last;

  int has_gal1_gal2_2h;
  int index_md_gal1_gal2_2h;
  int index_integrand_id_gal1_gal2_2h_first;
  int index_integrand_id_gal1_gal2_2h_last;
 ...
 /// gal1 x lensmag2
  int has_gal1_lensmag2_2h;
  int index_md_gal1_lensmag2_2h;
  int index_integrand_id_gal1_lensmag2_2h_first;
  int index_integrand_id_gal1_lensmag2_2h_last;

  int has_gal1_lensmag2_1h;
  int index_md_gal1_lensmag2_1h;
  int index_integrand_id_gal1_lensmag2_1h_first;
  int index_integrand_id_gal1_lensmag2_1h_last;
 /// gal2 x lensmag1
  int has_gal2_lensmag1_2h;
  int index_md_gal2_lensmag1_2h;
  int index_integrand_id_gal2_lensmag1_2h_first;
  int index_integrand_id_gal2_lensmag1_2h_last;

  int has_gal2_lensmag1_1h;
  int index_md_gal2_lensmag1_1h;
  int index_integrand_id_gal2_lensmag1_1h_first;
  int index_integrand_id_gal2_lensmag1_1h_last;
  ...
  int has_lensmag1_lensmag2_2h;
  int index_md_lensmag1_lensmag2_2h;
  int index_integrand_id_lensmag1_lensmag2_2h_first;
  int index_integrand_id_lensmag1_lensmag2_2h_last;

  int has_lensmag1_lensmag2_1h;
  int index_md_lensmag1_lensmag2_1h;
  int index_integrand_id_lensmag1_lensmag2_1h_first;
  int index_integrand_id_lensmag1_lensmag2_1h_last;
  ...
  int has_cib_lensmag_1h;
  int index_md_cib_lensmag_1h;
  int index_integrand_id_cib_lensmag_1h_first;
  int index_integrand_id_cib_lensmag_1h_last;

  int has_cib_lensmag_2h;
  int index_md_cib_lensmag_2h;
  int index_integrand_id_cib_lensmag_2h_first;
  int index_integrand_id_cib_lensmag_2h_last;
 ...
 /* vector of all SZ quantities function of redshift*/
  ...
  int  index_lensing1_profile;
  int  index_lensing2_profile;
  int  index_multipole_for_lensing_profile;
  int  index_multipole_for_lensing1_profile;
  int  index_multipole_for_lensing2_profile;
  ...
  int index_phi_galaxy1_counts;
  int index_mean_galaxy1_number_density;
  int index_mean_galaxy1_bias;
  int index_phi_galaxy2_counts;
  int index_mean_galaxy2_number_density;
  int index_mean_galaxy2_bias;
  int index_c500c;
  int index_multipole_for_galaxy_profile;
  int index_multipole_for_galaxy1_profile;
  int index_multipole_for_galaxy2_profile;
  int index_multipole_for_truncated_nfw_profile;
  int index_galaxy_profile;
  int index_galaxy1_profile;
  int index_galaxy2_profile;
  ...
  int index_W_lensmag;
  int index_W_lensmag1;
  int index_W_lensmag2;
  ...
  //HOD galaxy 1
  double M_min_HOD_gal1;
  double M0_HOD_gal1;
  double sigma_log10M_HOD_gal1;
  double alpha_s_HOD_gal1;
  double M1_prime_HOD_gal1;
  double rho_y_gal_gal1;

  //HOD galaxy 2
  double M_min_HOD_gal2;
  double M0_HOD_gal2;
  double sigma_log10M_HOD_gal2;
  double alpha_s_HOD_gal2;
  double M1_prime_HOD_gal2;
  double rho_y_gal_gal2;


  int M0_Mmin_flag;
  int M0_Mmin_flag_gal1;
  int M0_Mmin_flag_gal2;
...
double * steps_m;
  ...
  double f_cen_HOD;
  double x_out_truncated_nfw_profile_satellite_galaxies_gal1;
  double f_cen_HOD_gal1;
  double x_out_truncated_nfw_profile_satellite_galaxies_gal2;
  double f_cen_HOD_gal2;
  double Delta_z_lens;
...
//// galaxy 1
  double * normalized_source_dndz_z1;
  double * normalized_source_dndz_phig1;

  int normalized_source_dndz_size1;

  double * normalized_dndz_z1;
  double * normalized_dndz_phig1;

  int normalized_dndz_size1;

  double * normalized_fdndz_z1;
  double * normalized_fdndz_phig1;

  int normalized_fdndz_size1;

  double * normalized_cosmos_dndz_z1;
  double * normalized_cosmos_dndz_phig1;

  int normalized_cosmos_dndz_size1;

  /// galaxy 2
  double * normalized_source_dndz_z2;
  double * normalized_source_dndz_phig2;

  int normalized_source_dndz_size2;

  double * normalized_dndz_z2;
  double * normalized_dndz_phig2;

  int normalized_dndz_size2;

  double * normalized_fdndz_z2;
  double * normalized_fdndz_phig2;

  int normalized_fdndz_size2;

  double * normalized_cosmos_dndz_z2;
  double * normalized_cosmos_dndz_phig2;

  int normalized_cosmos_dndz_size2;
  ...
  double * array_z_W_lensmag1;
  double * array_W_lensmag1;
  double * array_z_W_lensmag2;
  double * array_W_lensmag2;
  ...
  double * array_mean_galaxy1_number_density;
  double * array_mean_galaxy2_number_density;
  double * array_mean_galaxy_bias;
  double * array_mean_galaxy1_bias;
  double * array_mean_galaxy2_bias;
...
double radial_kernel_W_galaxy_lensing_magnification_at_z(double z,
                                                         ...
                                                         struct background * pba,
                                                         struct tszspectrum * ptsz);
double radial_kernel_W_galaxy1_lensing_magnification_at_z(double z,
                                                        double * pvectsz,
                                                        struct background * pba,
                                                        struct tszspectrum * ptsz);
double radial_kernel_W_galaxy2_lensing_magnification_at_z(double z,
                                                         double * pvectsz,
                                                         struct background * pba,
                                                         struct tszspectrum * ptsz);
