...
class_sz_string_parameter(full_path_to_dndz_gal1,"/sz_auxiliary_files/WISC_bin3.txt","custom dndz file")
class_sz_string_parameter(full_path_to_dndz_gal2,"/sz_auxiliary_files/WISC_bin3.txt","custom dndz file")
...
class_sz_string_parameter(UNWISE_dndz_file1,"/sz_auxiliary_files/UNWISE_galaxy_distributions/normalised_dndz_cosmos.txt","unWISE dndz file")
class_sz_string_parameter(UNWISE_dndz_file2,"/sz_auxiliary_files/UNWISE_galaxy_distributions/normalised_dndz_cosmos.txt","unWISE dndz file")
