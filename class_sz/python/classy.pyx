...
# BB: modified for class_sz
    ...
    def cl_g1g2(self):
        """
        (class_sz) Return the 1-halo and 2-halo terms of g1xg2 power spectrum
        """
        cl = {}
        cl['ell'] = []
        cl['1h'] = []
        ...
        cl['hf'] = []
        for index in range(self.tsz.nlSZ):
            cl['1h'].append(self.tsz.cl_gal1_gal2_1h[index])
            cl['2h'].append(self.tsz.cl_gal1_gal2_2h[index])
            cl['ell'].append(self.tsz.ell[index])
        return cl

    def cl_m1m2(self):
        """
        (class_sz) Return the 1-halo and 2-halo terms of m1xm2 power spectrum
        """
        cl = {}
        cl['ell'] = []
        cl['1h'] = []
        ...
        cl['hf'] = []
        for index in range(self.tsz.nlSZ):
            cl['1h'].append(self.tsz.cl_lensmag1_lensmag2_1h[index])
            cl['2h'].append(self.tsz.cl_lensmag1_lensmag2_2h[index])
            cl['ell'].append(self.tsz.ell[index])
        return cl
    def cl_g1m2(self):
        """
        ...
        cl['hf'] = []
        for index in range(self.tsz.nlSZ):
            cl['1h'].append(self.tsz.cl_gal1_lensmag2_1h[index])
            cl['2h'].append(self.tsz.cl_gal1_lensmag2_2h[index])
            cl['ell'].append(self.tsz.ell[index])
        return cl
    ...
    def cl_g2m1(self):
        ...
        cl['hf'] = []
        for index in range(self.tsz.nlSZ):
            cl['1h'].append(self.tsz.cl_gal2_lensmag1_1h[index])
            cl['2h'].append(self.tsz.cl_gal2_lensmag1_2h[index])
            cl['ell'].append(self.tsz.ell[index])
        return cl
    ...
    def cl_cib_m(self):
        ...
        for id_nu1 in range(self.tsz.cib_frequency_list_num):
            ...
            cl['2h'] = []
            for index in range(self.tsz.nlSZ):
                cl['1h'].append(self.tsz.cl_cib_lensmag_1h[id_nu1][index])
                cl['2h'].append(self.tsz.cl_cib_lensmag_2h[id_nu1][index])
                cl['ell'].append(self.tsz.ell[index])
            cl_cib_m[str(int(nu1))] = cl
        return cl_cib_m
