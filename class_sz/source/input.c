  ...
  */
  ...
  if (flag1 == _TRUE_) {
    ...
    if ((strstr(string1,"mPk") != NULL) || (strstr(string1,"MPk") != NULL) || (strstr(string1,"MPK") != NULL)) {
      ...
      if ((strstr(string1,"gal1_gal2_1h") != NULL) ) {
        ptsz->has_gal1_gal2_1h =_TRUE_;
        ppt->has_density_transfers=_TRUE_;
        ppt->has_pk_matter = _TRUE_;
        ppt->has_perturbations = _TRUE_;
        pnl->has_pk_cb = _TRUE_;
      ...
      if ((strstr(string1,"gal1_gal2_2h") != NULL) ) {
      ...
      if ((strstr(string1,"gal1_lensmag2_1h") != NULL) ) {
      ...
      if ((strstr(string1,"gal1_lensmag2_2h") != NULL) ) {
      ...
      if ((strstr(string1,"gal2_lensmag1_1h") != NULL) ) {
      ...
      if ((strstr(string1,"gal2_lensmag1_2h") != NULL) ) {
      ...
      if ((strstr(string1,"lensmag1_lensmag2_1h") != NULL) ) {
      ...
      if ((strstr(string1,"lensmag1_lensmag2_2h") != NULL) ) {
      ...
      if ((strstr(string1,"cib_lensmag_1h") != NULL) ) {
      ...
      if ((strstr(string1,"cib_lensmag_2h") != NULL) ) {
    ...
    if (ptsz->has_cib_flux_cut != _FALSE_){
     ...
     if (flag1 == _TRUE_) {
      ...
      class_read_double("f_cen_HOD_gal1",ptsz->f_cen_HOD_gal1);
      class_read_double("f_cen_HOD_gal2",ptsz->f_cen_HOD_gal2);
      ...
      class_call(parser_read_string(pfc,"M0 equal M_min (HOD) gal1",&string1,&flag1,errmsg),
                 errmsg,
                 errmsg);
      if (flag1 == _TRUE_) {
        if ((strstr(string1,"no") != NULL))
          ptsz->M0_Mmin_flag_gal1=0;
        else  if ((strstr(string1,"yes") != NULL))
          ptsz->M0_Mmin_flag_gal1=1;
              }
      if (ptsz->M0_Mmin_flag_gal1 == 1){
      ptsz->M0_HOD_gal1 = ptsz->M_min_HOD_gal1;
      }
      else {
      class_read_double("M0_HOD_gal1",ptsz->M0_HOD_gal1);
      }

      class_call(parser_read_string(pfc,"M0 equal M_min (HOD) gal2",&string1,&flag1,errmsg),
                 errmsg,
                 errmsg);
      if (flag1 == _TRUE_) {
        if ((strstr(string1,"no") != NULL))
          ptsz->M0_Mmin_flag_gal2=0;
        else  if ((strstr(string1,"yes") != NULL))
          ptsz->M0_Mmin_flag_gal2=1;
              }
      if (ptsz->M0_Mmin_flag_gal2 == 1){
      ptsz->M0_HOD_gal2 = ptsz->M_min_HOD_gal2;
      }
      else {
      class_read_double("M0_HOD_gal2",ptsz->M0_HOD_gal2);
      }
      ...
      class_read_double("M1_prime_HOD_gal1",ptsz->M1_prime_HOD_gal1);
      class_read_double("alpha_s_HOD_gal1",ptsz->alpha_s_HOD_gal1);
      class_read_double("sigma_log10M_HOD_gal1",ptsz->sigma_log10M_HOD_gal1);
      class_read_double("x_out_truncated_nfw_profile_satellite_galaxies_gal1",ptsz->x_out_truncated_nfw_profile_satellite_galaxies_gal1);

      class_read_double("M1_prime_HOD_gal2",ptsz->M1_prime_HOD_gal2);
      class_read_double("alpha_s_HOD_gal2",ptsz->alpha_s_HOD_gal2);
      class_read_double("sigma_log10M_HOD_gal2",ptsz->sigma_log10M_HOD_gal2);
      class_read_double("x_out_truncated_nfw_profile_satellite_galaxies_gal2",ptsz->x_out_truncated_nfw_profile_satellite_galaxies_gal2);
...
class_read_int("no_tt_noise_in_kSZ2X_cov",ptsz->no_tt_noise_in_kSZ2X_cov);
     ...
     if (ptsz->integrate_wrt_mvir == 1) {
      ...
      class_read_string("UNWISE_dndz_file1",ptsz->UNWISE_dndz_file1);
      class_read_string("UNWISE_dndz_file2",ptsz->UNWISE_dndz_file2);
      class_read_string("UNWISE_fdndz_file",ptsz->UNWISE_fdndz_file);
   ...
   if (flag1 == _TRUE_) {
      ...
      /* galaxy sample */
      class_call(parser_read_string(pfc,"galaxy_sample1",&string1,&flag1,errmsg),
                 errmsg,
                 errmsg);
     if (flag1 == _TRUE_) {
        if ((strstr(string1,"WIxSC") != NULL))
          ptsz->galaxy_sample1=0;
        else  if ((strstr(string1,"unwise") != NULL))
          ptsz->galaxy_sample1=1;
        else  if ((strstr(string1,"custom") != NULL))
          ptsz->galaxy_sample1=2;
        }
        /* galaxy sample */
        class_call(parser_read_string(pfc,"galaxy_sample2",&string1,&flag1,errmsg),
                   errmsg,
                   errmsg);
       if (flag1 == _TRUE_) {
          if ((strstr(string1,"WIxSC") != NULL))
            ptsz->galaxy_sample2=0;
          else  if ((strstr(string1,"unwise") != NULL))
            ptsz->galaxy_sample2=1;
          else  if ((strstr(string1,"custom") != NULL))
            ptsz->galaxy_sample2=2;
          }
     ...
     if (flag1 == _TRUE_) {
        ...
        class_call(parser_read_string(pfc,"galaxy_sample_id1",&string1,&flag1,errmsg),
                   errmsg,
                   errmsg);
       if (flag1 == _TRUE_) {
          if ((strstr(string1,"red") != NULL))
            ptsz->unwise_galaxy_sample_id1=0;
          else  if ((strstr(string1,"green") != NULL))
            ptsz->unwise_galaxy_sample_id1=1;
          else  if ((strstr(string1,"gr_shallow") != NULL))
            ptsz->unwise_galaxy_sample_id1=2;
          else  if ((strstr(string1,"blue") != NULL))
            ptsz->unwise_galaxy_sample_id1=3;
          }
          class_call(parser_read_string(pfc,"galaxy_sample_id2",&string1,&flag1,errmsg),
                     errmsg,
                     errmsg);
         if (flag1 == _TRUE_) {
            if ((strstr(string1,"red") != NULL))
              ptsz->unwise_galaxy_sample_id2=0;
            else  if ((strstr(string1,"green") != NULL))
              ptsz->unwise_galaxy_sample_id2=1;
            else  if ((strstr(string1,"gr_shallow") != NULL))
              ptsz->unwise_galaxy_sample_id2=2;
            else  if ((strstr(string1,"blue") != NULL))
              ptsz->unwise_galaxy_sample_id2=3;
            }
  ...
  class_read_string("full_path_to_dndz_gal1",ptsz->full_path_to_dndz_gal1);
  class_read_string("full_path_to_dndz_gal2",ptsz->full_path_to_dndz_gal2);
...
int input_default_params(
  ...
  ptsz->M0_Mmin_flag_gal2 = 0;
  ptsz->f_cen_HOD = 1.;
  ptsz->f_cen_HOD_gal1 = 1.;
  ptsz->f_cen_HOD_gal2 = 1.;
  ptsz->Delta_z_lens = 0.;
  ...
  ptsz->x_out_truncated_nfw_profile_satellite_galaxies_gal1 =1.;
  ptsz->x_out_truncated_nfw_profile_satellite_galaxies_gal2 =1.;
  ...
  ptsz->galaxy_sample1 = 0; // WIxSC
  ptsz->galaxy_sample2 = 0; // WIxSC
  ptsz->unwise_galaxy_sample_id = -1; // red
  ptsz->unwise_galaxy_sample_id1 = -1; // red
  ptsz->unwise_galaxy_sample_id2 = -1; // red
  ...
  ptsz->n_z_W_lensmag1 = 500;
  ptsz->n_z_W_lensmag2 = 500;
  ...
  ptsz->has_gal1_gal2_1h = _FALSE_;
  ptsz->has_gal1_gal2_2h = _FALSE_;
  ...
  ptsz->has_gal1_lensmag2_1h = _FALSE_;
  ptsz->has_gal1_lensmag2_2h = _FALSE_;
  ptsz->has_gal2_lensmag1_1h = _FALSE_;
  ptsz->has_gal2_lensmag1_2h = _FALSE_;
  ...
  ptsz->has_lensmag1_lensmag2_1h = _FALSE_;
  ptsz->has_lensmag1_lensmag2_2h = _FALSE_;
  ...
  ptsz->has_cib_lensmag_1h = _FALSE_;
  ptsz->has_cib_lensmag_2h = _FALSE_;
  ...
  ptsz->index_md_gal1_gal2_1h = 93;
  ptsz->index_md_gal1_gal2_2h = 94;
  ptsz->index_md_lensmag1_lensmag2_2h = 95;
  ptsz->index_md_lensmag1_lensmag2_1h = 96;
  ptsz->index_md_gal1_lensmag2_2h = 97;
  ptsz->index_md_gal1_lensmag2_1h = 98;
  ptsz->index_md_gal2_lensmag1_2h = 99;
  ptsz->index_md_gal2_lensmag1_1h = 100;
  ptsz->index_md_cib_lensmag_1h = 101;
  ptsz->index_md_cib_lensmag_2h = 102;
  ...
  //HOD galaxy 1
  ptsz->M_min_HOD_gal1 = pow(10,11.5); //Msun/h
  ptsz->M1_prime_HOD_gal1 = pow(10,12.6); //Msun/h
  ptsz->alpha_s_HOD_gal1 = 1.;
  ptsz->sigma_log10M_HOD_gal1 = 0.15;

  //HOD galaxy 2
  ptsz->M_min_HOD_gal2 = pow(10,11.5); //Msun/h
  ptsz->M1_prime_HOD_gal2 = pow(10,12.6); //Msun/h
  ptsz->alpha_s_HOD_gal2 = 1.;
  ptsz->sigma_log10M_HOD_gal2 = 0.15;
