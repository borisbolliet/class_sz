...
// ptsz->has_sz_counts = _TRUE_;
  ...
  int all_comps = ptsz->has_sz_ps
      ...
      + ptsz->has_cib_lensmag_1h
      + ptsz->has_cib_lensmag_2h
      + ptsz->has_gal_cib_1h
      + ptsz->has_gal_cib_2h
      + ptsz->has_cib_cib_1h
      + ptsz->has_cib_cib_2h
      + ptsz->has_gal_gal_1h
      + ptsz->has_gal_gal_2h
      + ptsz->has_gal1_gal2_1h
      + ptsz->has_gal1_gal2_2h
      + ptsz->has_gal_gal_hf
      ...
      + ptsz->has_gal1_lensmag2_1h
      + ptsz->has_gal1_lensmag2_2h
      + ptsz->has_gal2_lensmag1_1h
      + ptsz->has_gal2_lensmag1_2h
      ...
      + ptsz->has_lensmag1_lensmag2_1h
      + ptsz->has_lensmag1_lensmag2_2h
...
if (ptsz->has_gal1_gal2_1h
  ...
  || ptsz->has_lensmag1_lensmag2_2h)
  {
    ...
    load_normalized_dndz1(ptsz); //galaxy 1
    load_normalized_dndz2(ptsz); //galaxy 2

    if(ptsz->galaxy_sample1==1)
    {
      load_normalized_fdndz1(ptsz);
      load_normalized_cosmos_dndz1(ptsz);
    }
    if(ptsz->galaxy_sample2==1)
    {
      load_normalized_fdndz2(ptsz);
      load_normalized_cosmos_dndz2(ptsz);
    }
  }
...
if (ptsz->has_gal1_gal2_1h
 || ptsz->has_gal1_gal2_2h)
{
  tabulate_mean_galaxy1_number_density(pba,pnl,ppm,ptsz);
  tabulate_mean_galaxy2_number_density(pba,pnl,ppm,ptsz);
}
if (ptsz->has_gal1_lensmag2_1h
 || ptsz->has_gal1_lensmag2_2h)
{
  tabulate_mean_galaxy1_number_density(pba,pnl,ppm,ptsz);
}
if (ptsz->has_gal2_lensmag1_1h
 || ptsz->has_gal2_lensmag1_2h)
{
  tabulate_mean_galaxy2_number_density(pba,pnl,ppm,ptsz);
}
...
if (ptsz->has_mean_galaxy1_bias)
{
  tabulate_mean_galaxy1_bias(pba,pnl,ppm,ppt,ptsz);
}


if (ptsz->has_mean_galaxy2_bias)
{
  tabulate_mean_galaxy2_bias(pba,pnl,ppm,ppt,ptsz);
}
...
// tabulate lensing magnificaion integral, only when requested
tabulate_redshift_int_lensmag1(ptsz,pba); //OK debug
// tabulate lensing magnificaion integral, only when requested
tabulate_redshift_int_lensmag2(ptsz,pba); //OK debug
...
int szpowerspectrum_free(struct tszspectrum *ptsz)
{
  ...
  if (ptsz->sz_verbose>10) printf("-> freeing l and cl's.\n");
   ...
   free(ptsz->cl_gal1_gal2_1h);
   free(ptsz->cl_gal1_gal2_2h);
   ...
   free(ptsz->cl_gal1_lensmag2_1h); // OK debug
   free(ptsz->cl_gal1_lensmag2_2h);
   free(ptsz->cl_gal2_lensmag1_1h);
   free(ptsz->cl_gal2_lensmag1_2h);
   ...
   free(ptsz->cl_lensmag1_lensmag2_1h);
   free(ptsz->cl_lensmag1_lensmag2_2h);
  ...
  if (ptsz->sz_verbose>10) printf("-> freeing l and cl's cib.\n");
   ...
   for (index_nu=0;index_nu<ptsz->cib_frequency_list_num;index_nu++){
     ...
     free(ptsz->cl_cib_lensmag_1h[index_nu]);
     free(ptsz->cl_cib_lensmag_2h[index_nu]);
   ...
   free(ptsz->cl_cib_lensmag_1h);
   free(ptsz->cl_cib_lensmag_2h);
...
|| ptsz->has_cib_lensmag_1h
|| ptsz->has_cib_lensmag_2h
){printf("----> freeing old lensmag.\n");
  free(ptsz->array_W_lensmag);
  free(ptsz->array_z_W_lensmag);
}

if (ptsz->has_lensmag1_lensmag2_1h
|| ptsz->has_lensmag1_lensmag2_2h
|| ptsz->has_gal1_lensmag2_1h
|| ptsz->has_gal1_lensmag2_2h
|| ptsz->has_gal2_lensmag1_1h
|| ptsz->has_gal2_lensmag1_2h
  ...
  printf("----> freeing new lensmag.\n");
  free(ptsz->array_W_lensmag1);
  free(ptsz->array_z_W_lensmag1);
  free(ptsz->array_W_lensmag2);
  free(ptsz->array_z_W_lensmag2);
}
...
if (ptsz->has_gal1_gal2_1h
   || ptsz->has_gal1_gal2_2h
   || ptsz->has_gal1_lensmag2_1h
   || ptsz->has_gal1_lensmag2_2h //OK debug
   ){
   free(ptsz->array_mean_galaxy1_number_density);
  }
...
if (ptsz->has_gal1_gal2_1h
   ...
   free(ptsz->array_mean_galaxy2_number_density);
  }
...
if (ptsz->has_mean_galaxy1_bias){
  free(ptsz->array_mean_galaxy1_bias);
}
if (ptsz->has_mean_galaxy2_bias){
  free(ptsz->array_mean_galaxy2_bias);
}
...
if (ptsz->has_gal1_gal2_1h
 ...
 ){ printf("freeeing dndzs \n");
   free(ptsz->normalized_dndz_z1);
   free(ptsz->normalized_dndz_phig1);

   free(ptsz->normalized_dndz_z2);
   free(ptsz->normalized_dndz_phig2);

  if (ptsz->galaxy_sample1 ==  1){
    free(ptsz->normalized_fdndz_z1);
    free(ptsz->normalized_fdndz_phig1);
    free(ptsz->normalized_cosmos_dndz_z1);
    free(ptsz->normalized_cosmos_dndz_phig1);
   }
   if (ptsz->galaxy_sample2 ==  1){
     free(ptsz->normalized_fdndz_z2);
     free(ptsz->normalized_fdndz_phig2);
     free(ptsz->normalized_cosmos_dndz_z2);
     free(ptsz->normalized_cosmos_dndz_phig2);
    }
...
int compute_sz(struct background * pba,
   ...
   if (index_integrand>=ptsz->index_integrand_id_dndlnM_first && index_integrand <= ptsz->index_integrand_id_dndlnM_last && ptsz->has_dndlnM){
      ...
      else if (index_integrand>=ptsz->index_integrand_id_gal1_gal2_1h_first && index_integrand <= ptsz->index_integrand_id_gal1_gal2_1h_last && ptsz->has_gal1_gal2_1h){
         Pvectsz[ptsz->index_md] = ptsz->index_md_gal1_gal2_1h;
         Pvectsz[ptsz->index_has_galaxy] = 1;
          Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal1_gal2_1h_first);
         if (ptsz->sz_verbose > 0) printf("computing cl^gal1-gal2_1h (NEW!!!) @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
       }
      else if (index_integrand>=ptsz->index_integrand_id_gal1_gal2_2h_first && index_integrand <= ptsz->index_integrand_id_gal1_gal2_2h_last && ptsz->has_gal1_gal2_2h){
         Pvectsz[ptsz->index_md] = ptsz->index_md_gal1_gal2_2h;
         Pvectsz[ptsz->index_has_galaxy] = 1;
         Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal1_gal2_2h_first);
         if (ptsz->sz_verbose > 0) printf("computing cl^gal1-gal2_2h (NEW!!!) @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
       }
      ...
      // gal1 x lensmag 2
      else if (index_integrand>=ptsz->index_integrand_id_gal1_lensmag2_1h_first && index_integrand <= ptsz->index_integrand_id_gal1_lensmag2_1h_last && ptsz->has_gal1_lensmag2_1h){
         Pvectsz[ptsz->index_md] = ptsz->index_md_gal1_lensmag2_1h;
         Pvectsz[ptsz->index_has_galaxy] = 1;
         Pvectsz[ptsz->index_has_lensing] = 1;
         Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal1_lensmag2_1h_first);
         if (ptsz->sz_verbose > 0) printf("computing cl^gal1-lensmag2_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
       }
       else if (index_integrand>=ptsz->index_integrand_id_gal1_lensmag2_2h_first && index_integrand <= ptsz->index_integrand_id_gal1_lensmag2_2h_last && ptsz->has_gal1_lensmag2_2h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_gal1_lensmag2_2h;
          Pvectsz[ptsz->index_has_galaxy] = 1;
          Pvectsz[ptsz->index_has_lensing] = 1;
          Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal1_lensmag2_2h_first);
          if (ptsz->sz_verbose > 0) printf("computing cl^gal1-lensmag2_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
        }

        // gal2 x lensmag 2
      else if (index_integrand>=ptsz->index_integrand_id_gal2_lensmag1_1h_first && index_integrand <= ptsz->index_integrand_id_gal2_lensmag1_1h_last && ptsz->has_gal2_lensmag1_1h){
         Pvectsz[ptsz->index_md] = ptsz->index_md_gal2_lensmag1_1h;
         Pvectsz[ptsz->index_has_galaxy] = 1;
         Pvectsz[ptsz->index_has_lensing] = 1;
         Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal2_lensmag1_1h_first);
         if (ptsz->sz_verbose > 0) printf("computing cl^gal2-lensmag1_1h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
       }
       else if (index_integrand>=ptsz->index_integrand_id_gal2_lensmag1_2h_first && index_integrand <= ptsz->index_integrand_id_gal2_lensmag1_2h_last && ptsz->has_gal2_lensmag1_2h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_gal2_lensmag1_2h;
          Pvectsz[ptsz->index_has_galaxy] = 1;
          Pvectsz[ptsz->index_has_lensing] = 1;
          Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_gal2_lensmag1_2h_first);
          if (ptsz->sz_verbose > 0) printf("computing cl^gal1-lensmag2_2h @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
        }
  ...
  else if (index_integrand>=ptsz->index_integrand_id_lensmag1_lensmag2_1h_first && index_integrand <= ptsz->index_integrand_id_lensmag1_lensmag2_1h_last && ptsz->has_lensmag1_lensmag2_1h){
     Pvectsz[ptsz->index_md] = ptsz->index_md_lensmag1_lensmag2_1h;
     // Pvectsz[ptsz->index_has_galaxy] = 1;
     Pvectsz[ptsz->index_has_lensing] = 1;
     Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_lensmag1_lensmag2_1h_first);
     if (ptsz->sz_verbose > 0) printf("computing cl^lensmag1-lensmag2_1h  (NEW) @ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
   }
   else if (index_integrand>=ptsz->index_integrand_id_lensmag1_lensmag2_2h_first && index_integrand <= ptsz->index_integrand_id_lensmag1_lensmag2_2h_last && ptsz->has_lensmag1_lensmag2_2h){
      Pvectsz[ptsz->index_md] = ptsz->index_md_lensmag1_lensmag2_2h;
      Pvectsz[ptsz->index_has_lensing] = 1;
      Pvectsz[ptsz->index_multipole] = (double) (index_integrand - ptsz->index_integrand_id_lensmag1_lensmag2_2h_first);
      if (ptsz->sz_verbose > 0) printf("computing cl^lensmag1-lensmag2_2h  (NEW)@ ell_id = %.0f\n",Pvectsz[ptsz->index_multipole]);
    }
        ...
        if (ptsz->sz_verbose > 0) printf("computing cl^lens-cib_1h @ frequency_id = %.0f, ell_id = %.0f\n",
        ...
        else if (index_integrand>=ptsz->index_integrand_id_cib_lensmag_1h_first && index_integrand <= ptsz->index_integrand_id_cib_lensmag_1h_last && ptsz->has_cib_lensmag_1h){
          Pvectsz[ptsz->index_md] = ptsz->index_md_cib_lensmag_1h;
          int index_multipole_cib1 = (double) (index_integrand - ptsz->index_integrand_id_cib_lensmag_1h_first);
          int index_cib1 = index_multipole_cib1 / ptsz->nlSZ;
          int index_multipole = index_multipole_cib1 % ptsz->nlSZ;
          Pvectsz[ptsz->index_multipole] = (double) index_multipole ;
          Pvectsz[ptsz->index_frequency_for_cib_profile] = (double) index_cib1;
          Pvectsz[ptsz->index_has_cib] = 1;
          Pvectsz[ptsz->index_has_lensing] = 1;
          if (ptsz->sz_verbose > 0) printf("computing cl^cib_lensmag_1h @ frequency_id = %.0f, ell_id = %.0f\n",
                                           Pvectsz[ptsz->index_frequency_for_cib_profile],
                                           Pvectsz[ptsz->index_multipole]);
          }
         else if (index_integrand>=ptsz->index_integrand_id_cib_lensmag_2h_first && index_integrand <= ptsz->index_integrand_id_cib_lensmag_2h_last && ptsz->has_cib_lensmag_2h){
            Pvectsz[ptsz->index_md] = ptsz->index_md_cib_lensmag_2h;
            int index_multipole_cib1 = (double) (index_integrand - ptsz->index_integrand_id_cib_lensmag_2h_first);
            int index_cib1 = index_multipole_cib1 / ptsz->nlSZ;
            int index_multipole = index_multipole_cib1 % ptsz->nlSZ;
            Pvectsz[ptsz->index_multipole] = (double) index_multipole ;
            Pvectsz[ptsz->index_frequency_for_cib_profile] = (double) index_cib1;
            Pvectsz[ptsz->index_has_cib] = 1;
            Pvectsz[ptsz->index_has_lensing] = 1;
            if (ptsz->sz_verbose > 0) printf("computing cl^cib_lensmag_2h @ frequency_id = %.0f, ell_id = %.0f\n",
                                             Pvectsz[ptsz->index_frequency_for_cib_profile],
                                             Pvectsz[ptsz->index_multipole]);
          }
...
// Collect g1xg2 1-halo at each multipole:
// result in y-units (dimensionless)
// [l(l+1)/2pi]*cl
if (_gal1_gal2_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gal1_gal2_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
                                 // printf("NEW \n");
                                 // printf("ell = %.3e\n",ptsz->ell[index_l]);
                                 // printf("g1g2 1h = %.3e\n",ptsz->cl_gal1_gal2_1h[index_l]);

}


// Collect g1xg2 2-halo at each multipole:
// result in y-units (dimensionless)
// [l(l+1)/2pi]*cl
if (_gal1_gal2_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gal1_gal2_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
  // printf("NEW \n");
  // printf("ell = %.3e\n",ptsz->ell[index_l]);
  // printf("g1g2 2h = %.3e\n",ptsz->cl_gal1_gal2_2h[index_l]);
...
// result in y-units (dimensionless)
// [l(l+1)/2pi]*cl
if (_gal1_lensmag2_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gal1_lensmag2_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
// result in y-units (dimensionless)
// [l(l+1)/2pi]*cl
if (_gal1_lensmag2_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gal1_lensmag2_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
// result in y-units (dimensionless)
// [l(l+1)/2pi]*cl
if (_gal2_lensmag1_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gal2_lensmag1_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
// result in y-units (dimensionless)
// [l(l+1)/2pi]*cl
if (_gal2_lensmag1_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_gal2_lensmag1_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_lensmag1_lensmag2_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_lensmag1_lensmag2_1h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
// result in y-units (dimensionless)
// [l(l+1)/2pi]*cl
if (_lensmag1_lensmag2_2h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 ptsz->cl_lensmag1_lensmag2_2h[index_l] = Pvectsz[ptsz->index_integral]
                                 *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                 /(2*_PI_);
...
if (_cib_lensmag_1h_){
 int index_l = (int) Pvectsz[ptsz->index_multipole];
 int index_cib1 = (int) Pvectsz[ptsz->index_frequency_for_cib_profile];
 ptsz->cl_cib_lensmag_1h[index_cib1][index_l] = Pvectsz[ptsz->index_integral]
                                             *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                             /(2*_PI_);
 //printf("ell = %.3e and cl_yg = %.3e\n",ptsz->ell[index_l],ptsz->cl_tSZ_gal_1h[index_l]);
...
int index_l = (int) Pvectsz[ptsz->index_multipole];
int index_cib1 = (int) Pvectsz[ptsz->index_frequency_for_cib_profile];
ptsz->cl_cib_lensmag_2h[index_cib1][index_l] = Pvectsz[ptsz->index_integral]
                                            *ptsz->ell[index_l]*(ptsz->ell[index_l]+1.)
                                            /(2*_PI_);
//printf("ell = %.3e and cl_yg = %.3e\n",ptsz->ell[index_l],ptsz->cl_tSZ_gal_1h[index_l]);
  ...
  // printf("hmf = %.5e ug = %.5e\n",pvectsz[ptsz->index_hmf],galaxy_profile_at_ell_1);
     ...
     evaluate_halo_bias(pvecback,pvectsz,pba,ppm,pnl,ppt,ptsz);
         ...
         pvectsz[ptsz->index_integrand] =  pvectsz[ptsz->index_hmf]
                                           ...
                                           *galaxy_profile_at_ell_1;
    // printf("galaxy_profile (OLD) = %.3e\n",galaxy_profile_at_ell_1); // BB debug
    }

    else if (_gal1_gal2_1h_){
      // int index_l = (int) pvectsz[ptsz->index_multipole];
      // pvectsz[ptsz->index_multipole_for_lensing_profile] = ptsz->ell[index_l];

      evaluate_galaxy1_profile_2h(kl,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);
      // pvectsz[ptsz->index_multipole_for_galaxy_profile] =  ptsz->ell[index_l];
      double galaxy1_profile_at_ell_1 = pvectsz[ptsz->index_galaxy1_profile];

      evaluate_galaxy2_profile_2h(kl,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);
      double galaxy2_profile_at_ell_1 = pvectsz[ptsz->index_galaxy2_profile];


      pvectsz[ptsz->index_integrand] =  pvectsz[ptsz->index_hmf]
                                        *galaxy1_profile_at_ell_1
                                        *galaxy2_profile_at_ell_1
                                        *damping_1h_term;

     }

     else if (_gal1_gal2_2h_){

             if ((int) pvectsz[ptsz->index_part_id_cov_hsv] ==  1) {

             evaluate_halo_bias(pvecback,pvectsz,pba,ppm,pnl,ppt,ptsz);
             int index_l = (int) pvectsz[ptsz->index_multipole];
             pvectsz[ptsz->index_multipole_for_galaxy1_profile] = ptsz->ell[index_l];

             evaluate_galaxy1_profile_2h(kl,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);

             pvectsz[ptsz->index_integrand] =  pvectsz[ptsz->index_hmf]
                                               *pvectsz[ptsz->index_galaxy1_profile]
                                               *pvectsz[ptsz->index_halo_bias];
                                             }
             ...
             evaluate_halo_bias(pvecback,pvectsz,pba,ppm,pnl,ppt,ptsz);
             int index_l = (int) pvectsz[ptsz->index_multipole];
             pvectsz[ptsz->index_multipole_for_galaxy2_profile] = ptsz->ell[index_l];

             evaluate_galaxy2_profile_2h(kl,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);

             pvectsz[ptsz->index_integrand] =  pvectsz[ptsz->index_hmf]
                                               *pvectsz[ptsz->index_galaxy2_profile]
                                               *pvectsz[ptsz->index_halo_bias];
                                             }
            }
...
else if (_gal1_lensmag2_1h_){

  // int index_l = (int) pvectsz[ptsz->index_multipole];
  // pvectsz[ptsz->index_multipole_for_galaxy_profile] = ptsz->ell[index_l];
  evaluate_galaxy1_profile_2h(kl,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);
  double galaxy_profile_at_ell_1 = pvectsz[ptsz->index_galaxy1_profile];

  // pvectsz[ptsz->index_multipole_for_lensing_profile] =  ptsz->ell[index_l];

  // OK debug
  evaluate_lensing2_profile(kl,m_delta_lensing,r_delta_lensing,c_delta_lensing,pvecback,pvectsz,pba,ptsz);
  double lensing_profile_at_ell_2 = pvectsz[ptsz->index_lensing2_profile];
...
// printf("tsz lensmag 2h %.3f\n",1.);
  ...
  pvectsz[ptsz->index_integrand] =   pvectsz[ptsz->index_hmf]
                                    *pvectsz[ptsz->index_lensing2_profile]
                                    *pvectsz[ptsz->index_halo_bias];
                                  }

     }

   else if (_gal2_lensmag1_1h_){

     // int index_l = (int) pvectsz[ptsz->index_multipole];
     // pvectsz[ptsz->index_multipole_for_galaxy_profile] = ptsz->ell[index_l];
     evaluate_galaxy2_profile_2h(kl,m_delta_gal,r_delta_gal,c_delta_gal,pvecback,pvectsz,pba,ptsz);
     double galaxy_profile_at_ell_1 = pvectsz[ptsz->index_galaxy2_profile];

     // pvectsz[ptsz->index_multipole_for_lensing_profile] =  ptsz->ell[index_l];
     evaluate_lensing1_profile(kl,m_delta_lensing,r_delta_lensing,c_delta_lensing,pvecback,pvectsz,pba,ptsz);
     double lensing_profile_at_ell_2 = pvectsz[ptsz->index_lensing1_profile];
...
// printf("tsz lensmag 2h %.3f\n",1.);
     ...
     pvectsz[ptsz->index_integrand] =   pvectsz[ptsz->index_hmf]
                                       *pvectsz[ptsz->index_lensing1_profile]
                                       *pvectsz[ptsz->index_halo_bias];
                                     }
...
// printf("tsz lensmag 2h %.3f\n",1.);
  ...
  else if (_lensmag1_lensmag2_1h_){
    // int index_l = (int) pvectsz[ptsz->index_multipole];
    // pvectsz[ptsz->index_multipole_for_lensing_profile] = ptsz->ell[index_l];
    evaluate_lensing1_profile(kl,m_delta_lensing,r_delta_lensing,c_delta_lensing,pvecback,pvectsz,pba,ptsz);
    evaluate_lensing2_profile(kl,m_delta_lensing,r_delta_lensing,c_delta_lensing,pvecback,pvectsz,pba,ptsz);
    double lensing_profile_at_ell_1 = pvectsz[ptsz->index_lensing1_profile];
    double lensing_profile_at_ell_2 = pvectsz[ptsz->index_lensing2_profile];
        pvectsz[ptsz->index_integrand] =  pvectsz[ptsz->index_hmf]
                                          *lensing_profile_at_ell_1
                                          *lensing_profile_at_ell_2
 ...
 else if (_lensmag1_lensmag2_2h_){ //OK debug ask Boris ??
//printf("(int) pvectsz[ptsz->index_part_id_cov_hsv] = %.e \n ", (int) pvectsz[ptsz->index_part_id_cov_hsv]);
   // evaluate_halo_bias(pvecback,pvectsz,pba,ppm,pnl,ppt,ptsz);
   // // int index_l = (int) pvectsz[ptsz->index_multipole];
   // // pvectsz[ptsz->index_multipole_for_lensing_profile] = ptsz->ell[index_l];
   // evaluate_lensing_profile(kl,m_delta_lensing,r_delta_lensing,c_delta_lensing,pvecback,pvectsz,pba,ptsz);
   ...
   //                                   *pvectsz[ptsz->index_halo_bias];
                ...
                evaluate_halo_bias(pvecback,pvectsz,pba,ppm,pnl,ppt,ptsz);
                int index_l = (int) pvectsz[ptsz->index_multipole];
                pvectsz[ptsz->index_multipole_for_lensing1_profile] = ptsz->ell[index_l];
                evaluate_lensing1_profile(kl,m_delta_lensing,r_delta_lensing,c_delta_lensing,pvecback,pvectsz,pba,ptsz);
                ...
                evaluate_halo_bias(pvecback,pvectsz,pba,ppm,pnl,ppt,ptsz);
                int index_l = (int) pvectsz[ptsz->index_multipole];
                pvectsz[ptsz->index_multipole_for_lensing2_profile] = ptsz->ell[index_l];
                evaluate_lensing2_profile(kl,m_delta_lensing,r_delta_lensing,c_delta_lensing,pvecback,pvectsz,pba,ptsz);
    ...
    pvectsz[ptsz->index_integrand] =  pvectsz[ptsz->index_hmf]
          ...
          else if (_cib_lensmag_1h_){ //OK debug
...
int evaluate_lensing1_profile(double kl,
                             double m_delta,
                             double r_delta,
                             double c_delta,
                             double * pvecback,
                             ...
                             struct tszspectrum * ptsz)
{
  ...
  double mass_nfw = m_delta;
   ...
   pvectsz[ptsz->index_lensing1_profile] = result;
  ...
  lensing_normalisation = 1.; // kappa
   ...
   pvectsz[ptsz->index_lensing1_profile] =  lensing_normalisation // dim less
                                           *mass_nfw // M
                                           *pvectsz[ptsz->index_lensing1_profile]
                                           /(pow(3.*pow(pba->H0/pba->h,2)/2./ptsz->Rho_crit_0,-1)*pow((1.+z),1.)/chi)
                                           ///pvectsz[ptsz->index_lensing_Sigma_crit] // Sigma_crit is in M/L^2
...
int evaluate_lensing2_profile(double kl,
                             double m_delta,
                             double r_delta,
                             double c_delta,
                             double * pvecback,
                             ...
                             struct tszspectrum * ptsz)
{
  ...
  double mass_nfw = m_delta;
   ...
   pvectsz[ptsz->index_lensing2_profile] = result;
  ...
  lensing_normalisation = 1.; // kappa
   ...
   pvectsz[ptsz->index_lensing2_profile] =  lensing_normalisation // dim less
                                           *mass_nfw // M
                                           *pvectsz[ptsz->index_lensing2_profile]
                                           /(pow(3.*pow(pba->H0/pba->h,2)/2./ptsz->Rho_crit_0,-1)*pow((1.+z),1.)/chi)
                                           ///pvectsz[ptsz->index_lensing_Sigma_crit] // Sigma_crit is in M/L^2
...
double evaluate_mean_galaxy_number_density_at_z(
                   ...
                   struct tszspectrum * ptsz)
  {
   ...
   double z_asked = log(1.+z);
   //printf("ptsz->n_arraySZ %.5e in NEW \n", ptsz->n_arraySZ);
   if (z<exp(ptsz->array_redshift[0])-1.)
      z_asked = ptsz->array_redshift[0];
   if (z>exp(ptsz->array_redshift[ptsz->n_arraySZ-1])-1.)
      z_asked =  ptsz->array_redshift[ptsz->n_arraySZ-1];
    ...
    // printf("array_redshift array \n");
    // for (int i = 0; i < 20.0 ; i++) {
    //     printf("%.5e \n", ptsz->array_redshift[i]);  }

    // printf("array_mean_galaxy_number_density array \n");
    //     for (int j = 0; j < 20.0 ; j++) {
    //         printf("%.5e \n", ptsz->array_mean_galaxy_number_density[j]);  }
...
double evaluate_mean_galaxy1_number_density_at_z(
                   double z,
                   struct tszspectrum * ptsz)
  {
   ...
   if (z>exp(ptsz->array_redshift[ptsz->n_arraySZ-1])-1.)
    ...
    // int length1 = sizeof(ptsz->array_redshift)/sizeof(ptsz->array_redshift[0]);

    // printf("array_redshift array \n");
    // for (int i = 0; i < 20.0 ; i++) {
    //     printf("%.5e \n", ptsz->array_redshift[i]);  }
    //
    // printf("array_mean_galaxy1_number_density array \n");
    //     for (int j = 0; j < 20.0 ; j++) {
    //         printf("%.5e \n", ptsz->array_mean_galaxy1_number_density[j]);  }

    // printf("n_arraySZ array \n");
    ...
    // printf("ptsz->array_redshift %.5e in NEW \n",  ptsz->array_redshift);
    // printf("ptsz->array_mean_galaxy1_number_density %.5e in NEW \n",  ptsz->array_mean_galaxy1_number_density);
    // printf("ptsz->n_arraySZ, ptsz->array_redshift, ptsz->array_mean_galaxy1_number_density, z_asked: variables for pwl_value_1d %.5e %.5e %.5e %.5e in NEW \n", ptsz->n_arraySZ, ptsz->array_redshift, ptsz->array_mean_galaxy1_number_density, z_asked);
      //
    // printf("z_asked %.5e \n", z_asked);
    return exp(pwl_value_1d(ptsz->n_arraySZ,
                            ptsz->array_redshift,
...
double evaluate_mean_galaxy2_number_density_at_z(
                   double z,
                   struct tszspectrum * ptsz)
  {
   ...
   if (z>exp(ptsz->array_redshift[ptsz->n_arraySZ-1])-1.)
    ...
    return exp(pwl_value_1d(ptsz->n_arraySZ,
                            ptsz->array_redshift,
                            ptsz->array_mean_galaxy2_number_density,
                            z_asked));
...
double get_mean_galaxy1_bias_at_z(
                   double z,
                   struct tszspectrum * ptsz)
  {
   ...
   if (z>exp(ptsz->array_redshift[ptsz->n_arraySZ-1])-1.)
    ...
    return exp(pwl_value_1d(ptsz->n_arraySZ,
                            ptsz->array_redshift,
                            ptsz->array_mean_galaxy1_bias,
                            z_asked));

}

double get_mean_galaxy2_bias_at_z(
                   double z,
                   struct tszspectrum * ptsz)
  {
...
if (ptsz->has_gal1_gal2_1h
   || ptsz->has_gal1_gal2_2h)
ng1  = exp(pwl_value_1d(ptsz->n_arraySZ,
                        ptsz->array_redshift,
                        ptsz->array_mean_galaxy1_number_density,
                        z_asked));
  ...
  fprintf(fp,"%.5e \t %.5e \t %.5e \t %.5e \t %.5e \t %.5e \t , %.5e \t ,%.5e \t %.5e \t %.5e\t %.5e\t %.5e\t %.5e\t %.5e\t %.5e\n",
          z,a,H_cosmo,H,sigma8,f,vrms2,sigma2_hsv,mvir,ng,ng1,mdel,mdel_prime,delta,delta_prime);
      ...
      for (index_l=0;index_l<ptsz->nlSZ;index_l++){
         ...
         double cov_cl_cl_2h = sig_cl_squared_binned_2h + ptsz->tllprime_sz[index_l][index_l]/ptsz->Omega_survey;
            ...
            fprintf(fp,
                    ...
                    ptsz->cl_cib_lensmag_1h[ptsz->id_nu_cib_to_save][index_l],
                    ptsz->cl_cib_lensmag_2h[ptsz->id_nu_cib_to_save][index_l],
                    ...
                    ptsz->cl_lensmag1_lensmag2_1h[index_l],
                    ptsz->cl_lensmag1_lensmag2_2h[index_l],
...
printf("\n\n");
printf("########################################\n");
printf("CIB x galaxy power spectrum 2-halo term (new):\n");
printf("########################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){
...
printf("\n\n");
printf("########################################\n");
printf("galaxy 1 x galaxy 2 power spectrum 1-halo term  (NEW !!!!!!):\n");
printf("########################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal1_gal2 (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_gal1_gal2_1h[index_l]);
}
}
if (ptsz->has_gal1_gal2_2h){
printf("\n\n");
printf("###########################################\n");
printf("galaxy 1 x galaxy 2 power spectrum 2-halo term (NEW !!!!!!):\n");
printf("###########################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal1_gal2 (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_gal1_gal2_2h[index_l]);
}
}
...
printf("\n\n");
printf("##########################################################\n");
printf("galaxy1 x lensing magnification2 power spectrum 1-halo term (NEW !!!!):\n");
printf("##########################################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal1_lensmag2 (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_gal1_lensmag2_1h[index_l]);
}
}
if (ptsz->has_gal1_lensmag2_2h){
printf("\n\n");
printf("##########################################################\n");
printf("galaxy1 x lensing magnification2 power spectrum 2-halo term (NEW !!!!):\n");
printf("##########################################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal1_lensmag2 (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_gal1_lensmag2_2h[index_l]);
}
}
...
printf("\n\n");
printf("##########################################################\n");
printf("galaxy2 x lensing magnification1 power spectrum 1-halo term (NEW !!!!):\n");
printf("##########################################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal2_lensmag1 (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_gal2_lensmag1_1h[index_l]);
}
}
if (ptsz->has_gal2_lensmag1_2h){
printf("\n\n");
printf("##########################################################\n");
printf("galaxy2 x lensing magnification1 power spectrum 2-halo term (NEW !!!!):\n");
printf("##########################################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_gal2_lensmag1 (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_gal2_lensmag1_2h[index_l]);
}
}
...
printf("\n\n");
printf("#########################################################################\n");
printf("lensing magnification 1 x lensing magnification 2 power spectrum 1-halo term (NEW !!!!):\n");
printf("#########################################################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_lensmag_lensmag (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_lensmag1_lensmag2_1h[index_l]);
}
}

if (ptsz->has_lensmag1_lensmag2_2h){
printf("\n\n");
printf("#########################################################################\n");
printf("lensing magnification 1 x lensing magnification 2 power spectrum 2-halo term (NEW !!!! ):\n");
printf("#########################################################################\n");
printf("\n");
int index_l;
for (index_l=0;index_l<ptsz->nlSZ;index_l++){

printf("ell = %e\t\t cl_lensmag_lensmag (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_lensmag1_lensmag2_2h[index_l]);
}
}
...
if (ptsz->has_lens_cib_1h){
printf("\n\n");
printf("#######################################\n");
printf("lensing x cib power spectrum 1-halo term:\n");
printf("#######################################\n");
printf("\n");
int index_l;
int index_nu;
...
printf("ell = %e\t\t cl_lens_cib (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_lens_cib_1h[index_nu][index_l]);
}
// }
}
}
...
printf("\n\n");
printf("#######################################\n");
printf("lensing x cib power spectrum 2-halo term:\n");
printf("#######################################\n");
printf("\n");
int index_l;
int index_nu;
...
if (ptsz->has_cib_lensmag_1h){
printf("\n\n");
printf("#######################################\n");
printf("cib x lensmag power spectrum 1-halo term:\n");
printf("#######################################\n");
printf("\n");
int index_l;
int index_nu;
...
printf("ell = %e\t\t cl_cib_lensmag (1h) = %e \n",ptsz->ell[index_l],ptsz->cl_cib_lensmag_1h[index_nu][index_l]);
}
// }
}
}

if (ptsz->has_cib_lensmag_2h){
printf("\n\n");
printf("#######################################\n");
printf("cib x lensmag power spectrum 2-halo term:\n");
printf("#######################################\n");
printf("\n");
int index_l;
int index_nu;
...
printf("ell = %e\t\t cl_cib_lensmag (2h) = %e \n",ptsz->ell[index_l],ptsz->cl_cib_lensmag_2h[index_nu][index_l]);
}
// }
}
}
...
if (ptsz->has_tSZ_cib_2h){
printf("\n\n");
printf("########################################\n");
printf("tSZ x cib power spectrum 2-halo term:\n");
printf("########################################\n");
printf("\n");
int index_l;
int index_nu;
...
if (ptsz->has_kSZ_kSZ_lensmag_1halo
  ...
  +ptsz->has_lensmag_lensmag_1h
  +ptsz->has_lensmag_lensmag_2h
  +ptsz->has_lensmag1_lensmag2_1h //OK debug
  +ptsz->has_lensmag1_lensmag2_2h
  +ptsz->has_tSZ_lens_1h
  +ptsz->has_tSZ_lens_2h
  +ptsz->has_tSZ_lensmag_1h
...
if (ptsz->need_hmf){
  ...
  if (ptsz->integrate_wrt_m500c == 1 && ptsz->has_200c == 1)
   ...
   ptsz->index_multipole_for_lensing1_profile = ptsz->index_multipole_for_lensing_profile+ 1; //OK debug
   ptsz->index_multipole_for_lensing2_profile = ptsz->index_multipole_for_lensing1_profile+ 1; // delete if not used
   ptsz->index_characteristic_multipole_for_nfw_profile = ptsz->index_multipole_for_lensing2_profile + 1;
   ...
   ptsz->index_lensing1_profile = ptsz->index_lensing_profile  +1;
   ptsz->index_lensing2_profile = ptsz->index_lensing1_profile  +1;
   ptsz->index_completeness = ptsz->index_lensing2_profile +1;
   ...
   ptsz->index_phi_galaxy1_counts = ptsz->index_phi_galaxy_counts + 1;
   ptsz->index_phi_galaxy2_counts = ptsz->index_phi_galaxy1_counts + 1;
   ptsz->index_mean_galaxy_number_density = ptsz->index_phi_galaxy2_counts+1;
   ptsz->index_mean_galaxy1_number_density= ptsz->index_mean_galaxy_number_density+1; //OK
   ptsz->index_mean_galaxy2_number_density = ptsz->index_mean_galaxy1_number_density+1;
   ptsz->index_c500c = ptsz->index_mean_galaxy2_number_density+1;
   ptsz->index_multipole_for_galaxy_profile = ptsz->index_c500c+1;
   ptsz->index_multipole_for_galaxy1_profile = ptsz->index_multipole_for_galaxy_profile+1;
   ptsz->index_multipole_for_galaxy2_profile = ptsz->index_multipole_for_galaxy1_profile+1;
   ptsz->index_multipole_for_truncated_nfw_profile = ptsz->index_multipole_for_galaxy2_profile+1;
   ptsz->index_galaxy_profile =  ptsz->index_multipole_for_truncated_nfw_profile + 1;
   ptsz->index_galaxy1_profile =  ptsz->index_galaxy_profile + 1;
   ptsz->index_galaxy2_profile =  ptsz->index_galaxy1_profile + 1;
   ptsz->index_multipole_for_cib_profile = ptsz->index_galaxy2_profile + 1;
   ...
   ptsz->index_W_lensmag1 = ptsz->index_W_lensmag + 1;
   ptsz->index_W_lensmag2 = ptsz->index_W_lensmag1 + 1;
   ptsz->index_c200m = ptsz->index_W_lensmag2 + 1;
...
//exit(0);
   ...
   class_alloc(ptsz->cl_gal1_gal2_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gal1_gal2_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   class_alloc(ptsz->cl_gal1_lensmag2_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gal1_lensmag2_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gal2_lensmag1_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_gal2_lensmag1_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   class_alloc(ptsz->cl_lensmag1_lensmag2_1h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   class_alloc(ptsz->cl_lensmag1_lensmag2_2h,sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
   ...
   for (index_l=0;index_l<ptsz->nlSZ;index_l++){
      ...
      ptsz->cl_gal1_gal2_1h[index_l] = 0.;
      ptsz->cl_gal1_gal2_2h[index_l] = 0.;
      ...
      ptsz->cl_gal1_lensmag2_1h[index_l] = 0.;
      ptsz->cl_gal1_lensmag2_2h[index_l] = 0.;
      ptsz->cl_gal2_lensmag1_1h[index_l] = 0.;
      ptsz->cl_gal2_lensmag1_2h[index_l] = 0.;
      ...
      ptsz->cl_lensmag1_lensmag2_1h[index_l] = 0.;
      ptsz->cl_lensmag1_lensmag2_2h[index_l] = 0.;
   ...
   class_alloc(ptsz->cl_cib_lensmag_1h,sizeof(double **)*ptsz->cib_frequency_list_num,ptsz->error_message);
   class_alloc(ptsz->cl_cib_lensmag_2h,sizeof(double **)*ptsz->cib_frequency_list_num,ptsz->error_message);
   ...
   for (index_nu=0;index_nu<ptsz->cib_frequency_list_num;index_nu++){
     ...
     class_alloc(ptsz->cl_cib_lensmag_1h[index_nu],sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
     class_alloc(ptsz->cl_cib_lensmag_2h[index_nu],sizeof(double *)*ptsz->nlSZ,ptsz->error_message);
...
for (index_l=0;index_l<ptsz->nlSZ;index_l++){
  ...
  ptsz->cl_cib_lensmag_1h[index_nu][index_l] = 0.;
  ptsz->cl_cib_lensmag_2h[index_nu][index_l] = 0.;
 ...
 // printf("counting integrands\n");
   ...
   ptsz->index_integrand_id_gal1_gal2_1h_first = ptsz->index_integrand_id_gal_gal_2h_last + 1;
   ptsz->index_integrand_id_gal1_gal2_1h_last = ptsz->index_integrand_id_gal1_gal2_1h_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_gal1_gal2_2h_first = ptsz->index_integrand_id_gal1_gal2_1h_last + 1;
   ptsz->index_integrand_id_gal1_gal2_2h_last = ptsz->index_integrand_id_gal1_gal2_2h_first + ptsz->nlSZ - 1;

   ptsz->index_integrand_id_gal_lens_1h_first = ptsz->index_integrand_id_gal1_gal2_2h_last + 1;
   ...
   ptsz->index_integrand_id_gal1_lensmag2_1h_first = ptsz->index_integrand_id_gal_lensmag_1h_last+ 1;
   ptsz->index_integrand_id_gal1_lensmag2_1h_last = ptsz->index_integrand_id_gal1_lensmag2_1h_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_gal2_lensmag1_1h_first = ptsz->index_integrand_id_gal1_lensmag2_1h_last + 1;
   ptsz->index_integrand_id_gal2_lensmag1_1h_last = ptsz->index_integrand_id_gal2_lensmag1_1h_first + ptsz->nlSZ - 1;


   ptsz->index_integrand_id_gal_gallens_1h_first = ptsz->index_integrand_id_gal2_lensmag1_1h_last + 1;
   ptsz->index_integrand_id_gal_gallens_1h_last = ptsz->index_integrand_id_gal_gallens_1h_first + ptsz->nlSZ - 1;
   ...
   ptsz->index_integrand_id_lensmag1_lensmag2_1h_first =  ptsz->index_integrand_id_lensmag_lensmag_1h_last + 1;
   ptsz->index_integrand_id_lensmag1_lensmag2_1h_last = ptsz->index_integrand_id_lensmag1_lensmag2_1h_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_lens_lensmag_1h_first = ptsz->index_integrand_id_lensmag1_lensmag2_1h_last + 1;
   ...
   ptsz->index_integrand_id_cib_lensmag_1h_first = ptsz->index_integrand_id_lens_cib_1h_last + 1;
   ptsz->index_integrand_id_cib_lensmag_1h_last = ptsz->index_integrand_id_cib_lensmag_1h_first + ptsz->nlSZ*ptsz->cib_frequency_list_num - 1;
   ptsz->index_integrand_id_gal_cib_1h_first = ptsz->index_integrand_id_cib_lensmag_1h_last + 1;
   ...
   ptsz->index_integrand_id_cib_lensmag_2h_first = ptsz->index_integrand_id_lens_cib_2h_last + 1;
   ptsz->index_integrand_id_cib_lensmag_2h_last = ptsz->index_integrand_id_cib_lensmag_2h_first + ptsz->nlSZ*ptsz->cib_frequency_list_num - 1;
   ptsz->index_integrand_id_gal_cib_2h_first = ptsz->index_integrand_id_cib_lensmag_2h_last + 1;
   ...
   ptsz->index_integrand_id_gal1_lensmag2_2h_first = ptsz->index_integrand_id_gal_lensmag_2h_last+ 1;
   ptsz->index_integrand_id_gal1_lensmag2_2h_last = ptsz->index_integrand_id_gal1_lensmag2_2h_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_gal2_lensmag1_2h_first = ptsz->index_integrand_id_gal1_lensmag2_2h_last + 1;
   ptsz->index_integrand_id_gal2_lensmag1_2h_last = ptsz->index_integrand_id_gal2_lensmag1_2h_first + ptsz->nlSZ - 1;

   ptsz->index_integrand_id_tSZ_lensmag_2h_first = ptsz->index_integrand_id_gal2_lensmag1_2h_last + 1;
   ...
   ptsz->index_integrand_id_lensmag1_lensmag2_2h_first = ptsz->index_integrand_id_lensmag_lensmag_2h_last +1;
   ptsz->index_integrand_id_lensmag1_lensmag2_2h_last = ptsz->index_integrand_id_lensmag1_lensmag2_2h_first + ptsz->nlSZ - 1;
   ptsz->index_integrand_id_lens_lensmag_2h_first = ptsz->index_integrand_id_lensmag1_lensmag2_2h_last + 1;
...
double radial_kernel_W_galaxy1_lensing_magnification_at_z(
                                            double z,
                                            double * pvectsz,
                                            struct background * pba,
                                            struct tszspectrum * ptsz){
     ...
     evaluate_redshift_int_lensmag1(pvectsz,ptsz);
     double redshift_int_lensmag1 = pvectsz[ptsz->index_W_lensmag1];
     // double chi = sqrt(V->pvectsz[V->ptsz->index_chi2]);
     // pvectsz[ptsz->index_lensing_Sigma_crit] = pow(3.*pow(pba->H0/pba->h,2)/2./ptsz->Rho_crit_0,-1)*pow((1.+z),1.)/(chi*redshift_int_lensmag1);
     pvectsz[ptsz->index_lensing_Sigma_crit] = 1./(redshift_int_lensmag1);

     if (isnan(pvectsz[ptsz->index_lensing_Sigma_crit])||isinf(pvectsz[ptsz->index_lensing_Sigma_crit])){
       printf("%.3e\n",redshift_int_lensmag1);
       printf("nan or inf in sigmacrit\n");
       exit(0);
     }
...
double radial_kernel_W_galaxy2_lensing_magnification_at_z(
                                           double z,
                                           double * pvectsz,
                                           struct background * pba,
                                           struct tszspectrum * ptsz){
    ...
    evaluate_redshift_int_lensmag2(pvectsz,ptsz);
    double redshift_int_lensmag2 = pvectsz[ptsz->index_W_lensmag2];
    // double chi = sqrt(V->pvectsz[V->ptsz->index_chi2]);
    // pvectsz[ptsz->index_lensing_Sigma_crit] = pow(3.*pow(pba->H0/pba->h,2)/2./ptsz->Rho_crit_0,-1)*pow((1.+z),1.)/(chi*redshift_int_lensmag2);
    pvectsz[ptsz->index_lensing_Sigma_crit] = 1./(redshift_int_lensmag2);

    if (isnan(pvectsz[ptsz->index_lensing_Sigma_crit])||isinf(pvectsz[ptsz->index_lensing_Sigma_crit])){
      printf("%.3e\n",redshift_int_lensmag2);
      printf("nan or inf in sigmacrit\n");
      exit(0);
    }
...
int index_l = (int)  pvectsz[ptsz->index_multipole];
double ell = ptsz->ell[index_l];
printf("----------------------------------------------------> We should not be getting here with lensmag \n");
evaluate_redshift_int_lensmag(pvectsz,ptsz);
...
double radial_kernel_W_galaxy1_at_z( double * pvecback,
                                    double * pvectsz,
                                    struct background * pba,
                                    struct tszspectrum * ptsz){
...
//unwise case
//f_dndz is fphi, which is f/If or bdNdz/ ∫bdNdz
if ((ptsz->galaxy_sample1==1 && index_md == ptsz->index_md_gal_gal_hf)
 || (ptsz->galaxy_sample1==1 && index_md == ptsz->index_md_gal_lens_hf)
 || (ptsz->galaxy_sample1==1 && index_md == ptsz->index_md_gal_lensmag_hf)
 || (ptsz->galaxy_sample1==1 && index_md == ptsz->index_md_lens_lensmag_hf)
 || (ptsz->galaxy_sample1==1 && index_md == ptsz->index_md_lensmag_lensmag_hf)
 || (ptsz->galaxy_sample1==1 && index_md == ptsz->index_md_kSZ_kSZ_gal_hf  && ptsz->use_fdndz_for_ksz2g_eff == 1)
)
{

evaluate_galaxy1_number_counts_fdndz(pvecback,pvectsz,pba,ptsz);
}
else{


evaluate_galaxy1_number_counts(pvecback,pvectsz,pba,ptsz);
...
//  normalized galaxy redshift distribution in the bin:
double phi_galaxy_at_z = pvectsz[ptsz->index_phi_galaxy1_counts];
//double phi_galaxy_at_z = 1.; // BB debug
// H_over_c_in_h_over_Mpc = dz/dChi
// phi_galaxy_at_z = dng/dz normalized
double result = H_over_c_in_h_over_Mpc*phi_galaxy_at_z;
...
double radial_kernel_W_galaxy2_at_z( double * pvecback,
                                    double * pvectsz,
                                    struct background * pba,
                                    struct tszspectrum * ptsz){
double H_over_c_in_h_over_Mpc = pvecback[pba->index_bg_H]/pba->h;
...
//unwise case
//f_dndz is fphi, which is f/If or bdNdz/ ∫bdNdz
if ((ptsz->galaxy_sample2==1 && index_md == ptsz->index_md_gal_gal_hf)
 || (ptsz->galaxy_sample2==1 && index_md == ptsz->index_md_gal_lens_hf)
 || (ptsz->galaxy_sample2==1 && index_md == ptsz->index_md_gal_lensmag_hf)
 || (ptsz->galaxy_sample2==1 && index_md == ptsz->index_md_lens_lensmag_hf)
 || (ptsz->galaxy_sample2==1 && index_md == ptsz->index_md_lensmag_lensmag_hf)
 || (ptsz->galaxy_sample2==1 && index_md == ptsz->index_md_kSZ_kSZ_gal_hf  && ptsz->use_fdndz_for_ksz2g_eff == 1)
)
{
evaluate_galaxy2_number_counts_fdndz(pvecback,pvectsz,pba,ptsz);
}
else{

evaluate_galaxy2_number_counts(pvecback,pvectsz,pba,ptsz);
// printf("ng = %.5e\n",pvectsz[ptsz->index_phi_galaxy_counts]);
}
//evaluate_galaxy_number_counts_fdndz(V->pvecback,V->pvectsz,V->pba,V->ptsz);

//  normalized galaxy redshift distribution in the bin:
double phi_galaxy_at_z = pvectsz[ptsz->index_phi_galaxy2_counts];
//double phi_galaxy_at_z = 1.; // BB debug
// H_over_c_in_h_over_Mpc = dz/dChi
// phi_galaxy_at_z = dng/dz normalized
double result = H_over_c_in_h_over_Mpc*phi_galaxy_at_z;
...
double evaluate_galaxy1_number_counts( double * pvecback,
                                      double * pvectsz,
                                      struct background * pba,
                                      struct tszspectrum * ptsz)
                                      {
...
pvectsz[ptsz->index_phi_galaxy1_counts] = get_galaxy1_number_counts(z_asked,ptsz);

                                    }

double evaluate_galaxy2_number_counts( double * pvecback,
                                      double * pvectsz,
                                      struct background * pba,
                                      struct tszspectrum * ptsz)
                                      {
...
pvectsz[ptsz->index_phi_galaxy2_counts] = get_galaxy2_number_counts(z_asked,ptsz);
...
double get_galaxy1_number_counts(double z,
                                struct tszspectrum * ptsz){
  ...
  //                              ptsz->normalized_cosmos_dndz_phig,
  //                              z_asked);
  if(z_asked<ptsz->normalized_dndz_z1[0])
     phig = 1e-100;
  else if (z_asked>ptsz->normalized_dndz_z1[ptsz->normalized_dndz_size1-1])
     phig = 1e-100;
else  phig =  pwl_value_1d(ptsz->normalized_dndz_size1,
                           ptsz->normalized_dndz_z1,
                           ptsz->normalized_dndz_phig1,
                           z_asked);
...
double get_galaxy2_number_counts(double z,
                                struct tszspectrum * ptsz){
  ...
  if(z_asked<ptsz->normalized_dndz_z2[0])
     phig = 1e-100;
  else if (z_asked>ptsz->normalized_dndz_z2[ptsz->normalized_dndz_size2-1])
     phig = 1e-100;
else  phig =  pwl_value_1d(ptsz->normalized_dndz_size2,
                           ptsz->normalized_dndz_z2,
                           ptsz->normalized_dndz_phig2,
                           z_asked);
...
double evaluate_galaxy1_number_counts_fdndz( double * pvecback,
                                            double * pvectsz,
                                            struct background * pba,
                                            struct tszspectrum * ptsz){
  ...
  if(z_asked<ptsz->normalized_fdndz_z1[0])
     phig = 1e-100;
  else if (z_asked>ptsz->normalized_fdndz_z1[ptsz->normalized_fdndz_size1-1])
     phig = 1e-100;
  else  phig =  pwl_value_1d(ptsz->normalized_fdndz_size1,
                               ptsz->normalized_fdndz_z1,
                               ptsz->normalized_fdndz_phig1,
                               z_asked);

pvectsz[ptsz->index_phi_galaxy1_counts] = phig;

                                    }



double evaluate_galaxy2_number_counts_fdndz( double * pvecback,
                                            double * pvectsz,
                                            struct background * pba,
                                            struct tszspectrum * ptsz){
  ...
  if(z_asked<ptsz->normalized_fdndz_z2[0])
     phig = 1e-100;
  else if (z_asked>ptsz->normalized_fdndz_z2[ptsz->normalized_fdndz_size2-1])
     phig = 1e-100;
  else  phig =  pwl_value_1d(ptsz->normalized_fdndz_size2,
                               ptsz->normalized_fdndz_z2,
                               ptsz->normalized_fdndz_phig2,
                               z_asked);

pvectsz[ptsz->index_phi_galaxy2_counts] = phig;
...
int evaluate_galaxy1_profile_2h(
                            double kl,
                            double m_delta,
                            double r_delta,
                            double c_delta,
...
M_halo = m_delta; // Msun_over_h
double z = pvectsz[ptsz->index_z];
double ng_bar =  evaluate_mean_galaxy1_number_density_at_z(z,ptsz);//pvectsz[ptsz->index_mean_galaxy_number_density];
...
double M_min_gal1;
double M0_gal1;
double M1_prime_gal1;
double sigma_log10M_gal1;

M_min_gal1 = ptsz->M_min_HOD_gal1;
M1_prime_gal1 = ptsz->M1_prime_HOD_gal1;
sigma_log10M_gal1 = ptsz->sigma_log10M_HOD_gal1;
M0_gal1 = ptsz->M0_HOD_gal1;
// printf("M_min_gal1 = %.3e\n",M_min_gal1);
// printf("M1_prime_gal1 = %.3e\n",M1_prime_gal1);

nc = HOD_mean_number_of_central_galaxies(z,M_halo,M_min_gal1,sigma_log10M_gal1,ptsz->f_cen_HOD_gal2,ptsz,pba);
ns = HOD_mean_number_of_satellite_galaxies(z,M_halo,nc,M0_gal1,ptsz->alpha_s_HOD_gal1,M1_prime_gal1,ptsz,pba);
double xout = ptsz->x_out_truncated_nfw_profile_satellite_galaxies_gal1;
// pvectsz[ptsz->index_multipole_for_truncated_nfw_profile] = pvectsz[ptsz->index_multipole_for_galaxy_profile];
// double l = pvectsz[ptsz->index_multipole_for_truncated_nfw_profile];
// double chi = sqrt(pvectsz[ptsz->index_chi2]);
// double k = (l+0.5)/chi;
...
ug_at_ell  = (1./ng_bar)*(nc+ns*us);
if (isinf(ug_at_ell) || isnan(ug_at_ell)){
printf("ng_bar galaxy 1 = %.3e nc = %.3e ns = %.3e us = %.3e\n",ng_bar,nc,ns,us);
exit(0);
}
pvectsz[ptsz->index_galaxy1_profile] = ug_at_ell;


}


int evaluate_galaxy2_profile_2h(
                            double kl,
                            double m_delta,
                            double r_delta,
                            double c_delta,
...
M_halo = m_delta; // Msun_over_h
double z = pvectsz[ptsz->index_z];
double ng_bar =  evaluate_mean_galaxy2_number_density_at_z(z,ptsz);//pvectsz[ptsz->index_mean_galaxy_number_density];
double nc;
double ns;
double us;
...
double M_min_gal2;
double M0_gal2;
double M1_prime_gal2;
double sigma_log10M_gal2;

M_min_gal2 = ptsz->M_min_HOD_gal2;
M1_prime_gal2 = ptsz->M1_prime_HOD_gal2;
sigma_log10M_gal2 = ptsz->sigma_log10M_HOD_gal2;
M0_gal2 = ptsz->M0_HOD_gal2;
// printf("M_min_gal2 = %.3e\n",M_min_gal2);
// printf("M1_prime_gal2 = %.3e\n",M1_prime_gal2);

nc = HOD_mean_number_of_central_galaxies(z,M_halo,M_min_gal2,sigma_log10M_gal2,ptsz->f_cen_HOD_gal2,ptsz,pba);
ns = HOD_mean_number_of_satellite_galaxies(z,M_halo,nc,M0_gal2,ptsz->alpha_s_HOD_gal2,M1_prime_gal2,ptsz,pba);
double xout = ptsz->x_out_truncated_nfw_profile_satellite_galaxies_gal2;
// pvectsz[ptsz->index_multipole_for_truncated_nfw_profile] = pvectsz[ptsz->index_multipole_for_galaxy_profile];
// double l = pvectsz[ptsz->index_multipole_for_truncated_nfw_profile];
// double chi = sqrt(pvectsz[ptsz->index_chi2]);
// double k = (l+0.5)/chi;
...
ug_at_ell  = (1./ng_bar)*(nc+ns*us);
if (isinf(ug_at_ell) || isnan(ug_at_ell)){
printf("ng_bar galaxy 2 = %.3e nc = %.3e ns = %.3e us = %.3e\n",ng_bar,nc,ns,us);
exit(0);
}
pvectsz[ptsz->index_galaxy2_profile] = ug_at_ell;
