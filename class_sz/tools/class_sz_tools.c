...
struct Parameters_for_integrand_lensmag1{
  struct tszspectrum * ptsz;
  struct background * pba;
  double * pvectsz;
};

struct Parameters_for_integrand_lensmag2{
  struct tszspectrum * ptsz;
  struct background * pba;
  double * pvectsz;
};
...
double integrand_lensmag1(double ln1pzs, void *p){

  struct Parameters_for_integrand_lensmag1 *V = ((struct Parameters_for_integrand_lensmag1 *) p);
...
//unwise: use Cosmos cross-match dndz
if (V->ptsz->galaxy_sample1==1){
if(z_asked<V->ptsz->normalized_cosmos_dndz_z1[0])
   phig = 1e-100;
else if (z_asked>V->ptsz->normalized_cosmos_dndz_z1[V->ptsz->normalized_cosmos_dndz_size1-1])
   phig = 1e-100;
else  phig =  pwl_value_1d(V->ptsz->normalized_cosmos_dndz_size1,
                             V->ptsz->normalized_cosmos_dndz_z1,
                             V->ptsz->normalized_cosmos_dndz_phig1,
                             z_asked);
// printf("integrand ok phig\n");
}
if (V->ptsz->galaxy_sample1==1){
...
phig = get_galaxy1_number_counts(z_asked,V->ptsz);
}
 dndzs = phig;
////////////////////////////////
...
double integrand_lensmag2(double ln1pzs, void *p){

  struct Parameters_for_integrand_lensmag2 *V = ((struct Parameters_for_integrand_lensmag2 *) p);
...
/////////////////////////////////
  ...
  double phig = 0.;
//unwise: use Cosmos cross-match dndz
if (V->ptsz->galaxy_sample2==1){
if(z_asked<V->ptsz->normalized_cosmos_dndz_z2[0])
   phig = 1e-100;
else if (z_asked>V->ptsz->normalized_cosmos_dndz_z2[V->ptsz->normalized_cosmos_dndz_size2-1])
   phig = 1e-100;
else  phig =  pwl_value_1d(V->ptsz->normalized_cosmos_dndz_size2,
                             V->ptsz->normalized_cosmos_dndz_z2,
                             V->ptsz->normalized_cosmos_dndz_phig2,
                             z_asked);
// printf("integrand ok phig\n");
}
if (V->ptsz->galaxy_sample2==1){
...
phig = get_galaxy2_number_counts(z_asked,V->ptsz);
}
 dndzs = phig;
////////////////////////////////
...
struct Parameters_for_integrand_lensmag V;
 ...
 struct Parameters_for_integrand_lensmag1 V;
   V.pvectsz = pvectsz;
   V.ptsz = ptsz;
   V.pba = pba;
...
struct Parameters_for_integrand_lensmag2 V;
  V.pvectsz = pvectsz;
  V.ptsz = ptsz;
  V.pba = pba;
...
if (   (ptsz->has_tSZ_gal_1h != _TRUE_ )
    ...
    && (ptsz->has_cib_lensmag_1h != _TRUE_ )
    && (ptsz->has_cib_lensmag_2h != _TRUE_ )
...
int load_normalized_dndz1(struct tszspectrum * ptsz)
{

// don't load the unwise  dndz  if none of the following are required:
// all quantities requiring galaxy or lensmag need that:
if (   (ptsz->has_gal1_gal2_1h != _TRUE_)
    && (ptsz->has_gal1_gal2_2h != _TRUE_)
    && (ptsz->has_lensmag1_lensmag2_1h != _TRUE_)
    && (ptsz->has_lensmag1_lensmag2_2h != _TRUE_)
    && (ptsz->has_gal1_lensmag2_1h != _TRUE_)
    && (ptsz->has_gal1_lensmag2_2h != _TRUE_)
    && (ptsz->has_gal2_lensmag1_1h != _TRUE_ )
    && (ptsz->has_gal2_lensmag1_2h != _TRUE_ ))
  return 0;

    if (ptsz->sz_verbose>=1){
        if (ptsz->galaxy_sample1 == 0)
        printf("-> Loading dndz WIxSC\n");
        if (ptsz->galaxy_sample1 == 1)
        printf("-> Loading dndz unwise\n");
        if (ptsz->galaxy_sample1 == 2)
        printf("-> Loading dndz file\n");
        }


  class_alloc(ptsz->normalized_dndz_z1,sizeof(double *)*100,ptsz->error_message);
  class_alloc(ptsz->normalized_dndz_phig1,sizeof(double *)*100,ptsz->error_message);
  ...
  if (ptsz->galaxy_sample1 == 1){
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the dndz file for unWISE galaxies 1 \n");
      printf("-> File Name: %s\n",ptsz->UNWISE_dndz_file);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
  ...
  else if (ptsz->galaxy_sample1 == 0){
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the dndz file for WISC3 galaxies 1 \n");
      printf("-> File Name: %s\n",ptsz->WISC3_dndz_file);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
 ...
 // process = popen(Filepath, "r");
  ...
  else if (ptsz->galaxy_sample1 == 2){
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the dndz file for galaxies 1 \n");
      printf("-> File Name: %s\n",ptsz->full_path_to_dndz_gal1);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
  class_open(process,ptsz->full_path_to_dndz_gal1, "r",ptsz->error_message);
  if (ptsz->sz_verbose > 0)
    printf("-> File opened successfully\n");
  // sprintf(Filepath,
  //         "%s%s",
  ...
  while (fgets(line, sizeof(line)-1, process) != NULL) {
    ...
    // red
    if (ptsz->unwise_galaxy_sample_id1 == 0)
    this_lnI = this_lnK;

    // green
    if (ptsz->unwise_galaxy_sample_id1 == 1 || ptsz->unwise_galaxy_sample_id1 == 2)
    this_lnI = this_lnJ;

    // blue
    //if (ptsz->unwise_galaxy_sample_id1 == 3)
    //this_lnI = this_lnI;
  ...
  // WIxSC and "other": just two column files
  else if ((ptsz->galaxy_sample1 == 0) || (ptsz->galaxy_sample1 == 2)){
  ...
  /* Close the process */
  // if (ptsz->galaxy_sample2 == 2){
  // // if (ptsz->galaxy_sample2 == 2 || ptsz->galaxy_sample2 == 0 ){
  //   status = pclose(process);
  // }
  // else{
    status = fclose(process);
  ...
  /** 3. Store the read results into CLASS structures */
  ptsz->normalized_dndz_size1 = n_data;
  /** Make room */

  class_realloc(ptsz->normalized_dndz_z1,
                ptsz->normalized_dndz_z1,
                ptsz->normalized_dndz_size1*sizeof(double),
                ptsz->error_message);
  class_realloc(ptsz->normalized_dndz_phig1,
  ...
  /** Store them */
  for (index_x=0; index_x<ptsz->normalized_dndz_size1; index_x++) {
    ptsz->normalized_dndz_z1[index_x] = lnx[index_x];
    ptsz->normalized_dndz_phig1[index_x] = lnI[index_x];
    // printf("z=%.3e phig=%.3e\n",ptsz->normalized_dndz_z[index_x],ptsz->normalized_dndz_z[index_x]);
  };
...
int load_normalized_fdndz1(struct tszspectrum * ptsz)
{
...
if ((ptsz->galaxy_sample1 == 0) || (ptsz->galaxy_sample1 == 2))
  return 0;
// if ((ptsz->galaxy_sample1 == 0) || (ptsz->galaxy_sample1 == 2))
//   return 0;
// if ((ptsz->galaxy_sample2 == 0) || (ptsz->galaxy_sample2 == 2))
//   return 0;

if (ptsz->sz_verbose >= 1)
printf("-> Loading fdndz gal 1 unwise \n");

  class_alloc(ptsz->normalized_fdndz_z1,sizeof(double *)*100,ptsz->error_message);
  class_alloc(ptsz->normalized_fdndz_phig1,sizeof(double *)*100,ptsz->error_message);
  ...
  /** 3. Store the read results into CLASS structures */
  ptsz->normalized_fdndz_size1 = n_data;
  /** Make room */

  class_realloc(ptsz->normalized_fdndz_z1,
                ptsz->normalized_fdndz_z1,
                ptsz->normalized_fdndz_size1*sizeof(double),
                ptsz->error_message);
  class_realloc(ptsz->normalized_fdndz_phig1,
  ...
  /** Store them */
  for (index_x=0; index_x<ptsz->normalized_fdndz_size1; index_x++) {
    ptsz->normalized_fdndz_z1[index_x] = lnx[index_x];
    ptsz->normalized_fdndz_phig1[index_x] = lnI[index_x];
    //print("z=%.3e phig=%.3e\n",ptsz->normalized_dndz_z[index_x])
  };
...
// unwise dndz deduced from cross-match with spectroscopic surveys
int load_normalized_cosmos_dndz1(struct tszspectrum * ptsz)
{
  // printf("gs = %d\n",ptsz->galaxy_sample);
// don't load the unwise  dndz  if none of the following are required:
if ( (ptsz->has_gal1_gal2_1h != _TRUE_ )
...
printf("-> Loading cosmos dndz unwise\n");
  ...
  class_alloc(ptsz->normalized_cosmos_dndz_z1,sizeof(double *)*100,ptsz->error_message);
  class_alloc(ptsz->normalized_cosmos_dndz_phig1,sizeof(double *)*100,ptsz->error_message);
  ...
  //unwise
    class_open(process,ptsz->UNWISE_cosmos_dndz_file, "r",ptsz->error_message);
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the cosmos dndz file for unWISE galaxies 1\n");
      printf("-> File Name: %s\n",ptsz->UNWISE_cosmos_dndz_file);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
  ...
  /** 3. Store the read results into CLASS structures */
  ptsz->normalized_cosmos_dndz_size1 = n_data;
  /** Make room */

  class_realloc(ptsz->normalized_cosmos_dndz_z1,
                ptsz->normalized_cosmos_dndz_z1,
                ptsz->normalized_cosmos_dndz_size1*sizeof(double),
                ptsz->error_message);
  class_realloc(ptsz->normalized_cosmos_dndz_phig1,
                ptsz->normalized_cosmos_dndz_phig1,
                ptsz->normalized_cosmos_dndz_size1*sizeof(double),
                ptsz->error_message);
  ...
  // printf("fillling the arrays of dim = %d\n",ptsz->normalized_cosmos_dndz_size);
  /** Store them */
  for (index_x=0; index_x<ptsz->normalized_cosmos_dndz_size1; index_x++) {
    ptsz->normalized_cosmos_dndz_z1[index_x] = lnx[index_x];
    ptsz->normalized_cosmos_dndz_phig1[index_x] = lnI[index_x];
    // printf("z=%.3e phig=%.3e\n",ptsz->normalized_dndz_z[index_x]);
  };
// exit(0);
  /** Release the memory used locally */
...
int load_normalized_dndz2(struct tszspectrum * ptsz)
{
...
if (ptsz->sz_verbose>=1){
  ...
  class_alloc(ptsz->normalized_dndz_z2,sizeof(double *)*100,ptsz->error_message);
  class_alloc(ptsz->normalized_dndz_phig2,sizeof(double *)*100,ptsz->error_message);
  ...
  if (ptsz->galaxy_sample2 == 1){
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the dndz file for unWISE galaxies 2\n");
      printf("-> File Name: %s\n",ptsz->UNWISE_dndz_file);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
  ...
  else if (ptsz->galaxy_sample2 == 0){
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the dndz file for WISC3 galaxies 2\n");
      printf("-> File Name: %s\n",ptsz->WISC3_dndz_file);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
 ...
 // process = popen(Filepath, "r");
  ...
  else if (ptsz->galaxy_sample2 == 2){
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the dndz file for galaxies 2 \n");
      printf("-> File Name: %s\n",ptsz->full_path_to_dndz_gal2);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
  class_open(process,ptsz->full_path_to_dndz_gal2, "r",ptsz->error_message);
  if (ptsz->sz_verbose > 0)
    printf("-> File opened successfully\n");
  // sprintf(Filepath,
  //         "%s%s",
  ...
  while (fgets(line, sizeof(line)-1, process) != NULL) {
    ...
    // red
    if (ptsz->unwise_galaxy_sample_id2 == 0)
    this_lnI = this_lnK;

    // green
    if (ptsz->unwise_galaxy_sample_id2 == 1 || ptsz->unwise_galaxy_sample_id2 == 2)
    this_lnI = this_lnJ;

    // blue
    //if (ptsz->unwise_galaxy_sample_id2 == 3)
    //this_lnI = this_lnI;
  ...
  // WIxSC and "other": just two column files
  else if ((ptsz->galaxy_sample2 == 0) || (ptsz->galaxy_sample2 == 2)){
  ...
  /** 3. Store the read results into CLASS structures */
  ptsz->normalized_dndz_size2 = n_data;
  /** Make room */

  class_realloc(ptsz->normalized_dndz_z2,
                ptsz->normalized_dndz_z2,
                ptsz->normalized_dndz_size2*sizeof(double),
                ptsz->error_message);
  class_realloc(ptsz->normalized_dndz_phig2,
  ...
  /** Store them */
  for (index_x=0; index_x<ptsz->normalized_dndz_size2; index_x++) {
    ptsz->normalized_dndz_z2[index_x] = lnx[index_x];
    ptsz->normalized_dndz_phig2[index_x] = lnI[index_x];
    // printf("z=%.3e phig=%.3e\n",ptsz->normalized_dndz_z[index_x],ptsz->normalized_dndz_z[index_x]);
  };
...
int load_normalized_fdndz2(struct tszspectrum * ptsz)
{
...
if (ptsz->sz_verbose >= 1)
printf("-> Loading fdndz gal2 unwise\n");

  class_alloc(ptsz->normalized_fdndz_z2,sizeof(double *)*100,ptsz->error_message);
  class_alloc(ptsz->normalized_fdndz_phig2,sizeof(double *)*100,ptsz->error_message);
  ...
  /** 3. Store the read results into CLASS structures */
  ptsz->normalized_fdndz_size2 = n_data;
  /** Make room */

  class_realloc(ptsz->normalized_fdndz_z2,
                ptsz->normalized_fdndz_z2,
                ptsz->normalized_fdndz_size2*sizeof(double),
                ptsz->error_message);
  class_realloc(ptsz->normalized_fdndz_phig2,
  ...
  /** Store them */
  for (index_x=0; index_x<ptsz->normalized_fdndz_size2; index_x++) {
    ptsz->normalized_fdndz_z2[index_x] = lnx[index_x];
    ptsz->normalized_fdndz_phig2[index_x] = lnI[index_x];
    //print("z=%.3e phig=%.3e\n",ptsz->normalized_dndz_z[index_x])
  };
...
// unwise dndz deduced from cross-match with spectroscopic surveys
int load_normalized_cosmos_dndz2(struct tszspectrum * ptsz)
{
  // printf("gs = %d\n",ptsz->galaxy_sample);
// don't load the unwise  dndz  if none of the following are required:
if ( (ptsz->has_gal1_gal2_1h != _TRUE_ )
...
printf("-> Loading cosmos dndz unwise\n");
  ...
  class_alloc(ptsz->normalized_cosmos_dndz_z2,sizeof(double *)*100,ptsz->error_message);
  class_alloc(ptsz->normalized_cosmos_dndz_phig2,sizeof(double *)*100,ptsz->error_message);
  ...
  //unwise
    class_open(process,ptsz->UNWISE_cosmos_dndz_file, "r",ptsz->error_message);
    if (ptsz->sz_verbose > 0){
      printf("-> Openning the cosmos dndz file for unWISE galaxies 2 \n");
      printf("-> File Name: %s\n",ptsz->UNWISE_cosmos_dndz_file);
      // printf("-> File Name: %s\n",ptsz->UNWISE_fdndz_file);
      // printf("-> File Name: %s\n",ptsz->A10_file);
    }
  ...
  /** 3. Store the read results into CLASS structures */
  ptsz->normalized_cosmos_dndz_size2 = n_data;
  /** Make room */

  class_realloc(ptsz->normalized_cosmos_dndz_z2,
                ptsz->normalized_cosmos_dndz_z2,
                ptsz->normalized_cosmos_dndz_size2*sizeof(double),
                ptsz->error_message);
  class_realloc(ptsz->normalized_cosmos_dndz_phig2,
                ptsz->normalized_cosmos_dndz_phig2,
                ptsz->normalized_cosmos_dndz_size2*sizeof(double),
                ptsz->error_message);
  ...
  // printf("fillling the arrays of dim = %d\n",ptsz->normalized_cosmos_dndz_size);
  /** Store them */
  for (index_x=0; index_x<ptsz->normalized_cosmos_dndz_size2; index_x++) {
    ptsz->normalized_cosmos_dndz_z2[index_x] = lnx[index_x];
    ptsz->normalized_cosmos_dndz_phig2[index_x] = lnI[index_x];
    // printf("z=%.3e phig=%.3e\n",ptsz->normalized_dndz_z[index_x]);
  };
// exit(0);
  /** Release the memory used locally */
...
if (((V->ptsz->has_gal1_gal2_1h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_gal2_1h))
   || ((V->ptsz->has_gal1_gal2_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_gal2_2h))

  ) {
     V->pvectsz[V->ptsz->index_mean_galaxy1_number_density] = evaluate_mean_galaxy1_number_density_at_z(z,V->ptsz);
     V->pvectsz[V->ptsz->index_mean_galaxy2_number_density] = evaluate_mean_galaxy2_number_density_at_z(z,V->ptsz);
 }


if (((V->ptsz->has_gal1_lensmag2_1h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_lensmag2_1h)) //OK debug
  || ((V->ptsz->has_gal1_lensmag2_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_lensmag2_2h))
...
if (((V->ptsz->has_gal2_lensmag1_1h == _TRUE_) && (index_md == V->ptsz->index_md_gal2_lensmag1_1h)) //OK debug
  || ((V->ptsz->has_gal2_lensmag1_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal2_lensmag1_2h))
) {
    V->pvectsz[V->ptsz->index_mean_galaxy2_number_density] = evaluate_mean_galaxy2_number_density_at_z(z,V->ptsz);
}
...
if (((V->ptsz->has_sz_2halo == _TRUE_) && (index_md == V->ptsz->index_md_2halo))
 || ((V->ptsz->has_gal1_gal2_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_gal2_2h)) //## BB debug
 ...
 || ((V->ptsz->has_cib_lensmag_2h == _TRUE_) && (index_md == V->ptsz->index_md_cib_lensmag_2h))
 || ((V->ptsz->has_tSZ_gal_2h == _TRUE_) && (index_md == V->ptsz->index_md_tSZ_gal_2h))
 || ((V->ptsz->has_gal_lens_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal_lens_2h))
 || ((V->ptsz->has_gal_lensmag_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal_lensmag_2h))
 || ((V->ptsz->has_gal1_lensmag2_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_lensmag2_2h))
 ...
 || ((V->ptsz->has_lens_lensmag_2h == _TRUE_) && (index_md == V->ptsz->index_md_lens_lensmag_2h))
 || ((V->ptsz->has_lensmag_lensmag_2h == _TRUE_) && (index_md == V->ptsz->index_md_lensmag_lensmag_2h))
 || ((V->ptsz->has_lensmag1_lensmag2_2h == _TRUE_) && (index_md == V->ptsz->index_md_lensmag1_lensmag2_2h))
...
// galaxy1 x galaxy2 needs Wg1
if ( ((V->ptsz->has_gal1_gal2_1h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_gal2_1h))
   ||((V->ptsz->has_gal1_gal2_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_gal2_2h))
  ){
// multiply by radial kernel for galaxies (squared for gxg quantities)
double Wg1 = radial_kernel_W_galaxy1_at_z(V->pvecback,V->pvectsz,V->pba,V->ptsz);
// printf("Wg1 = %.5e \n", Wg1);
// printf("result 1 = %.5e \n ", result);
result *= pow(Wg1/V->pvectsz[V->ptsz->index_chi2],1.);
double Wg2 = radial_kernel_W_galaxy2_at_z(V->pvecback,V->pvectsz,V->pba,V->ptsz);
// printf("Wg2 = %.5e \n", Wg2);
// printf("result 2 = %.5e \n ", result);
result *= pow(Wg2/V->pvectsz[V->ptsz->index_chi2],1.);
// printf("result 3 = %.5e \n ", result);
}

// galaxy1 x lensmag2 needs Wg1
if ( ((V->ptsz->has_gal1_lensmag2_1h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_lensmag2_1h))
   ||((V->ptsz->has_gal1_lensmag2_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal1_lensmag2_2h))
  ){
double Wg1 = radial_kernel_W_galaxy1_at_z(V->pvecback,V->pvectsz,V->pba,V->ptsz);
result *= pow(Wg1/V->pvectsz[V->ptsz->index_chi2],1.);
double Wm2 = radial_kernel_W_galaxy2_lensing_magnification_at_z(z,V->pvectsz,V->pba,V->ptsz);
result *= pow(Wm2,1.);
}

// galaxy1 x lensmag2 needs Wg1
if ( ((V->ptsz->has_gal2_lensmag1_1h == _TRUE_) && (index_md == V->ptsz->index_md_gal2_lensmag1_1h))
   ||((V->ptsz->has_gal2_lensmag1_2h == _TRUE_) && (index_md == V->ptsz->index_md_gal2_lensmag1_2h))
  ){
double Wg2 = radial_kernel_W_galaxy2_at_z(V->pvecback,V->pvectsz,V->pba,V->ptsz);
result *= pow(Wg2/V->pvectsz[V->ptsz->index_chi2],1.); //OK debug
double Wm1 = radial_kernel_W_galaxy1_lensing_magnification_at_z(z,V->pvectsz,V->pba,V->ptsz);
result *= pow(Wm1,1.);
}
...
if (((V->ptsz->has_kSZ_kSZ_lensmag_1halo == _TRUE_) && (index_md == V->ptsz->index_md_kSZ_kSZ_lensmag_1halo))
    ...
    ||((V->ptsz->has_lens_lensmag_1h == _TRUE_) && (index_md == V->ptsz->index_md_lens_lensmag_1h))
    ||((V->ptsz->has_lens_lensmag_2h == _TRUE_) && (index_md == V->ptsz->index_md_lens_lensmag_2h))
    ||((V->ptsz->has_cib_lensmag_1h == _TRUE_) && (index_md == V->ptsz->index_md_cib_lensmag_1h))
    ||((V->ptsz->has_cib_lensmag_2h == _TRUE_) && (index_md == V->ptsz->index_md_cib_lensmag_2h))
){
...
if(
  ((V->ptsz->has_lensmag1_lensmag2_1h == _TRUE_) && (index_md == V->ptsz->index_md_lensmag1_lensmag2_1h))
||((V->ptsz->has_lensmag1_lensmag2_2h == _TRUE_) && (index_md == V->ptsz->index_md_lensmag1_lensmag2_2h))
){
double Wm1 = radial_kernel_W_galaxy1_lensing_magnification_at_z(z,V->pvectsz,V->pba,V->ptsz);
//result *= pow(Wg1,1.);
...
double integrand_patterson_test(double logM, void *p){
  ...
  double result = integrand_at_m_and_z(logM,
                                        ...
                                        V->ppt,
                                        V->ptsz);
//printf("result integrand_patterson_test = %.5e {{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{ \n", result);
...
//                               ptsz);
  ...
  r = r_m_1*r_m_2;
     ...
     else if ( ((int) pvectsz[ptsz->index_md] == ptsz->index_md_cib_lensmag_2h )){
 ...
 if (ptsz->M1SZ == ptsz->m_min_counter_terms)  {
  ...
  else if ((int) pvectsz[ptsz->index_md] == ptsz->index_md_gal1_gal2_2h){
  double r_m_1; // first part of redshift integrand
  double r_m_2; // second part of redshift integrand
  ...
  else if ((int) pvectsz[ptsz->index_md] == ptsz->index_md_lensmag1_lensmag2_2h){
  double r_m_1; // first part of redshift integrand
  double r_m_2; // second part of redshift integrand
  ...
  else if ((int) pvectsz[ptsz->index_md] == ptsz->index_md_gal1_lensmag2_2h){
  double r_m_1; // first part of redshift integrand
  double r_m_2; // second part of redshift integrand
  ...
  else if ((int) pvectsz[ptsz->index_md] == ptsz->index_md_gal2_lensmag1_2h){
  double r_m_1; // first part of redshift integrand
  double r_m_2; // second part of redshift integrand
...
r = r_m_1*r_m_2;
  ...
  //printf("Integrate_using_Patterson_adaptive \n");
  //for (int i = 0; i < 20; i++) {
     // for (int i = 0; i < 20; i++) {
     //    printf("%.5e ", integrand_patterson_test[i]);}
...
if ( (int) pvectsz[ptsz->index_md] != ptsz->index_md_cov_N_N
 ...
 || ((int) pvectsz[ptsz->index_md] == ptsz->index_md_cib_lensmag_2h) // OK debug
 || ((int) pvectsz[ptsz->index_md] == ptsz->index_md_lensmag_lensmag_2h)
 || ((int) pvectsz[ptsz->index_md] == ptsz->index_md_lensmag1_lensmag2_2h) // OK debug idk if this should be here
...
if (( (int) pvectsz[ptsz->index_md] == ptsz->index_md_2halo)
 ...
 || ((int) pvectsz[ptsz->index_md] == ptsz->index_md_gal_gal_2h)
 //OK gal1 x gal2 is not autocorrelations!
 || ((int) pvectsz[ptsz->index_md] == ptsz->index_md_gallens_gallens_2h)
 || ((int) pvectsz[ptsz->index_md] == ptsz->index_md_gallens_lens_2h)
){
// printf("............................. got to squaring 2h r = %.5e \n", r);
 pvectsz[ptsz->index_integral_over_m] = r*r;

 }
else{
//printf("............................. got to squaring 1h r = %.5e \n", r);
...
struct Parameters_for_integrand_mean_galaxy1_bias{
  struct nonlinear * pnl;
  struct primordial * ppm;
  struct tszspectrum * ptsz;
  struct background * pba;
...
struct Parameters_for_integrand_mean_galaxy2_bias{
  struct nonlinear * pnl;
  struct primordial * ppm;
  struct tszspectrum * ptsz;
  struct background * pba;
...
double integrand_mean_galaxy1_bias(double lnM_halo, void *p){

  struct Parameters_for_integrand_mean_galaxy1_bias *V = ((struct Parameters_for_integrand_mean_galaxy1_bias *) p);
    ...
    double z = V->z;
      ...
      M_min = V->ptsz->M_min_HOD_gal1;
      //printf("M_min = %.3e\n",M_min);
      M0 = V->ptsz->M0_HOD_gal2;
      M1_prime = V->ptsz->M1_prime_HOD_gal1;
      sigma_log10M = V->ptsz->sigma_log10M_HOD_gal1;
      // }
      nc = HOD_mean_number_of_central_galaxies(z,V->pvectsz[V->ptsz->index_mass_for_galaxies],M_min,sigma_log10M,V->ptsz->f_cen_HOD_gal1,V->ptsz,V->pba);
      ns = HOD_mean_number_of_satellite_galaxies(z,V->pvectsz[V->ptsz->index_mass_for_galaxies],nc,M0,V->ptsz->alpha_s_HOD_gal1,M1_prime,V->ptsz,V->pba);
      evaluate_halo_bias(V->pvecback,V->pvectsz,V->pba,V->ppm,V->pnl,V->ppt,V->ptsz);
      double result = hmf*V->pvectsz[V->ptsz->index_halo_bias]*(ns+nc);
...
double integrand_mean_galaxy2_bias(double lnM_halo, void *p){

  struct Parameters_for_integrand_mean_galaxy2_bias *V = ((struct Parameters_for_integrand_mean_galaxy2_bias *) p);
    ...
    double z = V->z;
      ...
      M_min = V->ptsz->M_min_HOD_gal2;
      //printf("M_min = %.3e\n",M_min);
      M0 = V->ptsz->M0_HOD_gal2;
      M1_prime = V->ptsz->M1_prime_HOD_gal2;
      sigma_log10M = V->ptsz->sigma_log10M_HOD_gal2;
      // }
      nc = HOD_mean_number_of_central_galaxies(z,V->pvectsz[V->ptsz->index_mass_for_galaxies],M_min,sigma_log10M,V->ptsz->f_cen_HOD_gal2,V->ptsz,V->pba);
      ns = HOD_mean_number_of_satellite_galaxies(z,V->pvectsz[V->ptsz->index_mass_for_galaxies],nc,M0,V->ptsz->alpha_s_HOD_gal2,M1_prime,V->ptsz,V->pba);
      evaluate_halo_bias(V->pvecback,V->pvectsz,V->pba,V->ppm,V->pnl,V->ppt,V->ptsz);
      double result = hmf*V->pvectsz[V->ptsz->index_halo_bias]*(ns+nc);
...
struct Parameters_for_integrand_mean_galaxy1_number{
  struct nonlinear * pnl;
  struct primordial * ppm;
  struct tszspectrum * ptsz;
  struct background * pba;
...
struct Parameters_for_integrand_mean_galaxy2_number{
  struct nonlinear * pnl;
  struct primordial * ppm;
  struct tszspectrum * ptsz;
  struct background * pba;
...
double integrand_mean_galaxy1_number(double lnM_halo, void *p){
...
double integrand_mean_galaxy2_number(double lnM_halo, void *p){
...
int tabulate_mean_galaxy1_number_density(struct background * pba,
                                        struct nonlinear * pnl,
                                        struct primordial * ppm,
                                        struct tszspectrum * ptsz){

class_alloc(ptsz->array_mean_galaxy1_number_density,sizeof(double *)*ptsz->n_arraySZ,ptsz->error_message);
...
for (index_z=0; index_z<ptsz->n_arraySZ; index_z++)
        {
          ...
          // at each z, perform the mass integral
          struct Parameters_for_integrand_mean_galaxy1_number V;
          V.pnl = pnl;
          V.ppm = ppm;
          V.ptsz = ptsz;
          V.pba = pba;
        ...
        // add counter terms:
         double nmin = get_hmf_counter_term_nmin_at_z(pvectsz[ptsz->index_z],ptsz);
         double I0 = integrand_mean_galaxy1_number(log(m_min),params);
         double nmin_umin = nmin*I0/pvectsz[ptsz->index_hmf];
         r += nmin_umin;



          ptsz->array_mean_galaxy1_number_density[index_z] = log(r);
...
int tabulate_mean_galaxy2_number_density(struct background * pba,
                                        struct nonlinear * pnl,
                                        struct primordial * ppm,
                                        struct tszspectrum * ptsz){

class_alloc(ptsz->array_mean_galaxy2_number_density,sizeof(double *)*ptsz->n_arraySZ,ptsz->error_message);
...
for (index_z=0; index_z<ptsz->n_arraySZ; index_z++)
        ...
        // add counter terms:
         double nmin = get_hmf_counter_term_nmin_at_z(pvectsz[ptsz->index_z],ptsz);
         double I0 = integrand_mean_galaxy2_number(log(m_min),params);
         double nmin_umin = nmin*I0/pvectsz[ptsz->index_hmf];
         r += nmin_umin;



          ptsz->array_mean_galaxy2_number_density[index_z] = log(r);
...
int tabulate_mean_galaxy1_bias(struct background * pba,
                              struct nonlinear * pnl,
                              struct primordial * ppm,
                              struct perturbs * ppt,
                              struct tszspectrum * ptsz){

class_alloc(ptsz->array_mean_galaxy1_bias,sizeof(double *)*ptsz->n_arraySZ,ptsz->error_message);
...
for (index_z=0; index_z<ptsz->n_arraySZ; index_z++)
        {
          ...
          // at each z, perform the mass integral
          struct Parameters_for_integrand_mean_galaxy1_bias V;
          V.pnl = pnl;
          V.ppm = ppm;
          V.ptsz = ptsz;
          V.pba = pba;
        ...
        // add counter terms:
         ...
         double nmin = get_hmf_counter_term_nmin_at_z(pvectsz[ptsz->index_z],ptsz);
         double bmin = get_hmf_counter_term_b1min_at_z(pvectsz[ptsz->index_z],ptsz)*nmin;
         double I0 = integrand_mean_galaxy1_bias(log(ptsz->m_min_counter_terms),params);
         double bmin_umin = bmin*I0/pvectsz[ptsz->index_hmf]/pvectsz[ptsz->index_halo_bias];
         r += bmin_umin;



          ptsz->array_mean_galaxy1_bias[index_z] = log(r/evaluate_mean_galaxy1_number_density_at_z(z,ptsz));
          // printf("ng = %.8e\n",r);
...
int tabulate_mean_galaxy2_bias(struct background * pba,
                              struct nonlinear * pnl,
                              struct primordial * ppm,
                              struct perturbs * ppt,
                              struct tszspectrum * ptsz){

class_alloc(ptsz->array_mean_galaxy2_bias,sizeof(double *)*ptsz->n_arraySZ,ptsz->error_message);
...
for (index_z=0; index_z<ptsz->n_arraySZ; index_z++)
        ...
        // add counter terms:
         ...
         double nmin = get_hmf_counter_term_nmin_at_z(pvectsz[ptsz->index_z],ptsz);
         double bmin = get_hmf_counter_term_b1min_at_z(pvectsz[ptsz->index_z],ptsz)*nmin;
         double I0 = integrand_mean_galaxy2_bias(log(ptsz->m_min_counter_terms),params);
         double bmin_umin = bmin*I0/pvectsz[ptsz->index_hmf]/pvectsz[ptsz->index_halo_bias];
         r += bmin_umin;



          ptsz->array_mean_galaxy2_bias[index_z] = log(r/evaluate_mean_galaxy2_number_density_at_z(z,ptsz));
          // printf("ng = %.8e\n",r);
...
int tabulate_redshift_int_lensmag1(struct tszspectrum * ptsz,
                                  struct background * pba){
...
if (ptsz->sz_verbose>=1){
  printf("-> Tabulating Wz for lensing magnification 1 \n");
}
  //Array of z
  double z_min = r8_min(ptsz->z1SZ,ptsz->z1SZ_dndlnM);
  double z_max = r8_max(ptsz->z2SZ,ptsz->z2SZ_dndlnM);
  int index_z;
  double ln1pz,z;
  class_alloc(ptsz->array_W_lensmag1,sizeof(double *)*ptsz->n_z_W_lensmag1,ptsz->error_message);
  class_alloc(ptsz->array_z_W_lensmag1,sizeof(double *)*ptsz->n_z_W_lensmag1,ptsz->error_message);
  double * pvectsz;
  class_alloc(pvectsz,ptsz->tsz_size*sizeof(double),ptsz->error_message);
  ...
  for (index_z=0; index_z<ptsz->n_z_W_lensmag1; index_z++)
  {
    ln1pz =  log(1.+z_min)
              +index_z*(log(1.+z_max)-log(1.+z_min))
              /(ptsz->n_z_W_lensmag1-1.); // log(1+z)
    ...
    double result;
    redshift_int_lensmag1(ptsz,pba,pvectsz,&result);

    if (result <= 0.)
      result = 1e-100;
    ptsz->array_W_lensmag1[index_z] = log(result);
    ptsz->array_z_W_lensmag1[index_z] = ln1pz;
    //printf("-> integral z = %.3e W = =%.3e\n",z,exp(ptsz->array_W_lensmag1[index_z]));
}
// if (ptsz->sz_verbose>=1)
//
//  free(pvectsz);
...
int tabulate_redshift_int_lensmag2(struct tszspectrum * ptsz,
                                  struct background * pba){
...
if (ptsz->sz_verbose>=1){
printf("-> Tabulating Wz for lensing magnification 2 \n");
}
  //Array of z
  double z_min = r8_min(ptsz->z1SZ,ptsz->z1SZ_dndlnM);
  double z_max = r8_max(ptsz->z2SZ,ptsz->z2SZ_dndlnM);
  ...
  class_alloc(ptsz->array_W_lensmag2,sizeof(double *)*ptsz->n_z_W_lensmag2,ptsz->error_message);
  class_alloc(ptsz->array_z_W_lensmag2,sizeof(double *)*ptsz->n_z_W_lensmag2,ptsz->error_message);
  double * pvectsz;
  class_alloc(pvectsz,ptsz->tsz_size*sizeof(double),ptsz->error_message);
  ...
  for (index_z=0; index_z<ptsz->n_z_W_lensmag2; index_z++)
  {
    ln1pz =  log(1.+z_min)
              +index_z*(log(1.+z_max)-log(1.+z_min))
              /(ptsz->n_z_W_lensmag2-1.); // log(1+z)
    ...
    double result;
    redshift_int_lensmag2(ptsz,pba,pvectsz,&result);

    if (result <= 0.)
      result = 1e-100;
    ptsz->array_W_lensmag2[index_z] = log(result);
    ptsz->array_z_W_lensmag2[index_z] = ln1pz;
}
// if (ptsz->sz_verbose>=1)
//  free(pvectsz);
//  free(pvecback);
...
int evaluate_redshift_int_lensmag1(double * pvectsz,
                                  struct tszspectrum * ptsz)
  {
   ...
   if (z<exp(ptsz->array_z_W_lensmag1[0])-1.)
      z_asked = ptsz->array_z_W_lensmag1[0];
   if (z>exp(ptsz->array_z_W_lensmag1[ptsz->n_z_W_lensmag1-1])-1.)
      z_asked =  ptsz->array_z_W_lensmag1[ptsz->n_z_W_lensmag1-1];


   pvectsz[ptsz->index_W_lensmag1] =  exp(pwl_value_1d(ptsz->n_z_W_lensmag1,
                                                        ptsz->array_z_W_lensmag1,
                                                        ptsz->array_W_lensmag1,
                                                        z_asked));

return _SUCCESS_;
}

int evaluate_redshift_int_lensmag2(double * pvectsz,
                                  struct tszspectrum * ptsz)
  {
   ...
   if (z<exp(ptsz->array_z_W_lensmag2[0])-1.)
      z_asked = ptsz->array_z_W_lensmag2[0];
   if (z>exp(ptsz->array_z_W_lensmag2[ptsz->n_z_W_lensmag2-1])-1.)
      z_asked =  ptsz->array_z_W_lensmag2[ptsz->n_z_W_lensmag2-1];


   pvectsz[ptsz->index_W_lensmag2] =  exp(pwl_value_1d(ptsz->n_z_W_lensmag2,
                                                        ptsz->array_z_W_lensmag2,
                                                        ptsz->array_W_lensmag2,
                                                        z_asked));
